...
!function () {
    function e(e, t, n) {
        t !== !1 ? k.addEventListener(e, Z[e], n) : k.removeEventListener(e, Z[e])
    }

    function t(e) {
        var t = T(e.target), i = E(t);
        if (ionic.tap.requiresNativeClick(i) || X)return !1;
    ...
    function r(t) {
        if (!t.isIonicTap && !_(t)) {
            if (H)return t.stopPropagation(), ionic.tap.isTextInput(t.target) && W === t.target || /^(select|option)$/i.test(t.target.tagName) || t.preventDefault(), !1;
            X = !1, F = ionic.tap.pointerCoord(t), e("mousemove"), ionic.activator.start(t)
        }
    }

    function o(n) {
        return H ? (n.stopPropagation(), n.preventDefault(), !1) : _(n) || /^(select|option)$/i.test(n.target.tagName) ? !1 : (v(n) || t(n), e("mousemove", !1), ionic.activator.end(), void(X = !1))
    }

    function s(t) {
        return v(t) ? (e("mousemove", !1), ionic.activator.end(), X = !0, !1) : void 0
    }

    function a(t) {
        if (!_(t) && (X = !1, d(), F = ionic.tap.pointerCoord(t), e(U), ionic.activator.start(t), ionic.Platform.isIOS() && ionic.tap.isLabelWithTextInput(t.target))) {
            var n = E(T(t.target));
    ...
    function l(e) {
        _(e) || (d(), v(e) || (t(e), /^(select|option)$/i.test(e.target.tagName) && e.preventDefault()), W = e.target, u())
    }

    function c(t) {
        return v(t) ? (X = !0, e(U, !1), ionic.activator.end(), !1) : void 0
    }

    function u() {
        e(U, !1), ionic.activator.end(), X = !1
    }

    function d() {
        H = !0, clearTimeout(z), z = setTimeout(function () {
            H = !1
        }, 2e3)
    }
    ...
    function h(e) {
        $ = null;
        var t = !1;
        "SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : g() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, H && ($ = e)) : f(), t && (g(e), ionic.trigger("ionic.focusin", {target: e}, !0))
    }
    ...
    function p(e) {
        H && ionic.tap.isTextInput(g()) && ionic.tap.isTextInput($) && $ !== e.target && ($.focus(), $ = null), ionic.scroll.isScrolling = !1
    }
    ...
    function g(e) {
        return arguments.length && (Y = e), Y || document.activeElement
    }

    function v(e) {
        if (!e || 1 !== e.target.nodeType || !F || 0 === F.x && 0 === F.y)return !1;
        var t = ionic.tap.pointerCoord(e), n = !(!e.target.classList || !e.target.classList.contains || "function" != typeof e.target.classList.contains), i = n && e.target.classList.contains("button") ? B : q;
        return Math.abs(F.x - t.x) > i || Math.abs(F.y - t.y) > i
    }
    ...
    function S() {
        P() ? (window.addEventListener("native.keyboardshow", b), window.addEventListener("native.keyboardhide", L), window.addEventListener("native.showkeyboard", b), window.addEventListener("native.hidekeyboard", L)) : document.body.addEventListener("focusout", L), document.body.addEventListener("ionic.focusin", w), document.body.addEventListener("focusin", w), document.body.addEventListener("orientationchange", I), window.navigator.msPointerEnabled ? document.removeEventListener("MSPointerDown", S) : document.removeEventListener("touchstart", S)
    }

    function b(e) {
        clearTimeout(j), ionic.keyboard.height = e.keyboardHeight
    }

    function w(e) {
        e.target && !e.target.readOnly && ionic.tap.isKeyboardElement(e.target) && G(e.target) && (document.addEventListener("keydown", M, !1), document.body.scrollTop = 0, document.body.querySelector(".scroll-content").scrollTop = 0, K = e.target, y(e))
    }

    function y(e) {
        clearTimeout(J), clearTimeout(j), J = setTimeout(function () {
            if (!(tt + 350 > Date.now())) {
                tt = Date.now();
                var t, n = K.getBoundingClientRect(), i = 0;
                Q = setInterval(function () {
                    t = A(), i > 10 && (clearInterval(Q), t = 275), t && (clearInterval(Q), D(e.target, n.top, n.bottom, et, t)), i++
                }, 100)
            }
        }, 32)
    }
    ...
    function D(e, t, n, i, r) {
        var o = {
            target: e,
            elementTop: Math.round(t),
            elementBottom: Math.round(n),
            keyboardHeight: r,
            viewportHeight: i
        };
        return o.hasPlugin = P(), o.contentHeight = i - r, o.isElementUnderKeyboard = o.elementBottom > o.contentHeight, ionic.keyboard.isOpen = !0, K = e, ionic.trigger("scrollChildIntoView", o, !0), ionic.requestAnimationFrame(function () {
            document.body.classList.add(nt)
        }), window.navigator.msPointerEnabled ? document.addEventListener("MSPointerMove", N, !1) : document.addEventListener("touchmove", N, !1), o
    }

    function L() {
        clearTimeout(j), j = setTimeout(ionic.keyboard.hide, 350)
    }
    ...
    function I() {
        var e = C();
        if (e === et)var t = 0, n = setInterval(function () {
            t > 10 && clearInterval(n), e = C(), e !== et && (ionic.keyboard.landscape = et > e ? !0 : !1, et = e, clearInterval(n)), t++
        }, 50); else et = e
    }

    function A() {
        return ionic.keyboard.height ? ionic.keyboard.height : ionic.Platform.isAndroid() ? ionic.Platform.isFullScreen ? 275 : C() < et ? et - C() : 0 : ionic.Platform.isIOS() ? ionic.keyboard.landscape ? 206 : ionic.Platform.isWebView() ? 260 : 216 : 275
    }
    ...
    function G(e) {
        for (; e;) {
            if (e.classList.contains(it))return !0;
            e = e.parentElement
        }
        return !1
    }
    ...
    function O() {
        ...
        for (e = 0; e < document.head.children.length; e++)if ("viewport" == document.head.children[e].name) {
            rt = document.head.children[e];
            break
        }
        if (rt) {
            var t, n = rt.content.toLowerCase().replace(/\s+/g, "").split(",");
            for (e = 0; e < n.length; e++)n[e] && (t = n[e].split("="), ot[t[0]] = t.length > 1 ? t[1] : "_");
            R()
        }
    }

    function R() {
        var e = ot.width, t = ot.height, n = ionic.Platform, i = n.version(), r = "device-width", o = "device-height", s = ionic.viewport.orientation();
        delete ot.height, ot.width = r, n.isIPad() ? i > 7 ? delete ot.width : n.isWebView() ? 90 == s ? ot.height = "0" : 7 == i && (ot.height = o) : 7 > i && (ot.height = "0") : n.isIOS() && (n.isWebView() ? i > 7 ? delete ot.width : 7 > i ? t && (ot.height = "0") : 7 == i && (ot.height = o) : 7 > i && t && (ot.height = "0")), (e !== ot.width || t !== ot.height) && V()
    }

    function V() {
        var e, t = [];
        for (e in ot)ot[e] && t.push(e + ("_" == ot[e] ? "" : "=" + ot[e]));
        rt.content = t.join(", ")
    }

    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.1", function (e) {
            ...
            requestAnimationFrame: function (t) {
                ...
                if (t.createRange) {
                    ...
                    if (i.selectNodeContents(n), i.getBoundingClientRect) {
                        ...
                        if (r) {
                            var o = e.scrollX, s = e.scrollY;
                            return {
                                top: r.top + s,
                                left: r.left + o,
                                right: r.left + o + r.width,
                                bottom: r.top + s + r.height,
                                width: r.width,
                                height: r.height
                            }
                        }
                ...
                if (t)for (var n, i = e.parentNode.children, r = 0, o = 0, s = i.length; s > r; r++)if (n = i[r], n.nodeName && n.nodeName.toLowerCase() == t) {
                    if (n == e)return o;
                    o++
                }
        ...
        e.CustomEvent = function () {
            ...
            on: function (t, n, i) {
                for (var r = i || window, o = 0, s = this.VIRTUALIZED_EVENTS.length; s > o; o++)if (t == this.VIRTUALIZED_EVENTS[o]) {
        ...
        e.Gesture = function (t, n) {
            ...
            var r = this;
            if (null !== n)return t(), this.element = n, this.enabled = !0, this.options = e.Gestures.utils.extend(e.Gestures.utils.extend({}, e.Gestures.defaults), i || {}), this.options.stop_browser_behavior && e.Gestures.utils.stopDefaultBrowserBehavior(this.element, this.options.stop_browser_behavior), e.Gestures.event.onTouch(n, e.Gestures.EVENT_START, function (t) {
        ...
        e.Gestures.event = {
            ...
            }, onTouch: function (t, o, s) {
                var a = this;
                this.bindDom(t, e.Gestures.EVENT_TYPES[o], function (l) {
            ...
            extendEventData: function (t) {
                ...
                var o = t.timeStamp - n.timeStamp, s = t.center.pageX - n.center.pageX, a = t.center.pageY - n.center.pageY, l = e.Gestures.utils.getVelocity(o, s, a);
            ...
            triggered: !1,
            handler: function (t, n) {
                if ("touchstart" == t.srcEvent.type || "touchend" == t.srcEvent.type ? this.preventedFirstMove = !1 : this.preventedFirstMove || "touchmove" != t.srcEvent.type || (t.srcEvent.preventDefault(), this.preventedFirstMove = !0), e.Gestures.detection.current.name != this.name && this.triggered)return n.trigger(this.name + "end", t), void(this.triggered = !1);
                if (!(n.options.drag_max_touches > 0 && t.touches.length > n.options.drag_max_touches))switch (t.eventType) {
                    ...
                    case e.Gestures.EVENT_MOVE:
                        ...
                        t.drag_locked_to_axis && r !== t.direction && (t.direction = e.Gestures.utils.isVertical(r) ? t.deltaY < 0 ? e.Gestures.DIRECTION_UP : e.Gestures.DIRECTION_DOWN : t.deltaX < 0 ? e.Gestures.DIRECTION_LEFT : e.Gestures.DIRECTION_RIGHT), this.triggered || (n.trigger(this.name + "start", t), this.triggered = !0), n.trigger(this.name, t), n.trigger(this.name + t.direction, t), (n.options.drag_block_vertical && e.Gestures.utils.isVertical(t.direction) || n.options.drag_block_horizontal && !e.Gestures.utils.isVertical(t.direction)) && t.preventDefault();
                        break;
                    case e.Gestures.EVENT_END:
        ...
        function r() {
            d.isWebView() ? t.addEventListener("deviceready", o, !1) : o(), s && e.removeEventListener("load", r, !1)
        }

        function o() {
            d.isReady = !0, d.detect();
            for (var e = 0; e < f.length; e++)f[e]();
            f = [], n.trigger("platformready", {target: t}), u(function () {
                t.body.classList.add("platform-ready")
            })
        }

        var s, a = "ios", l = "android", c = "windowsphone", u = n.requestAnimationFrame, d = n.Platform = {
            ...
            _checkPlatforms: function () {
                d.platforms = [];
                var e = "a";
                d.isWebView() ? (d.platforms.push("webview"), d.platforms.push("cordova")) : d.platforms.push("browser"), d.isIPad() && d.platforms.push("ipad");
                var t = d.platform();
                if (t) {
                    d.platforms.push(t);
                    var n = d.version();
                    if (n) {
                        var i = n.toString();
                        i.indexOf(".") > 0 ? i = i.replace(".", "_") : i += "_0", d.platforms.push(t + i.split("_")[0]), d.platforms.push(t + i), d.isAndroid() && 4.4 > n ? e = 4 > n ? "c" : "b" : d.isWindowsPhone() && (e = "b")
                    }
                }
                d.setGrade(e)
            },
        ...
        "complete" === t.readyState ? r() : (s = !0, e.addEventListener("load", r, !1))
    ...
    var k, Y, H, z, X, F, $, W, U = "touchmove", q = 12, B = 50, Z = {
        click: i,
        mousedown: r,
        mouseup: o,
        mousemove: s,
    ...
    ionic.tap = {
        register: function (t) {
            return k = t, e("click", !0, !0), e("mouseup"), e("mousedown"), window.navigator.pointerEnabled ? (e("pointerdown"), e("pointerup"), e("pointcancel"), U = "pointermove") : window.navigator.msPointerEnabled ? (e("MSPointerDown"), e("MSPointerUp"), e("MSPointerCancel"), U = "MSPointerMove") : (e("touchstart"), e("touchend"), e("touchcancel")), e("focusin"), e("focusout"), function () {
                for (var t in Z)e(t, !1);
                k = null, Y = null, H = !1, X = !1, F = null
            }
            ...
            ionic.tap.hasCheckedClone = !1, ionic.requestAnimationFrame(function () {
                ...
                for (t = 0; t < i.length; t++)i[t].classList.remove("previous-input-focus"), i[t].style.top = "", i[t].focus()
            })
        ...
        function i() {
            for (var e in o)o[e] && (o[e].classList.add(l), s[e] = o[e]);
            o = {}
        }
        ...
        var o = {}, s = {}, a = 0, l = "activated";
        t.activator = {
            start: function (e) {
                var n = t.tap.pointerCoord(e).x;
                n > 0 && 45 > n || t.requestAnimationFrame(function () {
                    if (!(t.scroll && t.scroll.isScrolling || t.tap.requiresNativeClick(e.target))) {
                        for (var n, r = e.target, s = 0; 6 > s && (r && 1 === r.nodeType); s++) {
                        ...
                        n && (o[a] = n, t.requestAnimationFrame(i), a = a > 29 ? 0 : a + 1)
                    }
                })
            }, end: function () {
                setTimeout(n, 200)
        ...
        e.Utils = {
            arrayMove: function (e, t, n) {
                ...
                n || (n = {});
                var l = function () {
                    a = n.leading === !1 ? 0 : Date.now(), s = null, o = e.apply(i, r)
                };
                return function () {
                    var c = Date.now();
                    a || n.leading !== !1 || (a = c);
                ...
                for (var e, n = t.length; n;) {
                    if (n--, e = t[n].charCodeAt(0), 57 == e)return t[n] = "A", t.join("");
                    if (90 != e)return t[n] = String.fromCharCode(e + 1), t.join("");
                    t[n] = "0"
                }
                return t.unshift("0"), t.join("")
    ...
    var K, j, J, Q, et = C(), tt = 0, nt = "keyboard-open", it = "scroll";
    ionic.keyboard = {
        isOpen: !1, height: null, landscape: !1, hide: function () {
            clearTimeout(J), clearTimeout(j), clearTimeout(Q), ionic.keyboard.isOpen = !1, ionic.trigger("resetScrollView", {target: K}, !0), ionic.requestAnimationFrame(function () {
                document.body.classList.remove(nt)
            }), window.navigator.msPointerEnabled ? document.removeEventListener("MSPointerMove", N) : document.removeEventListener("touchmove", N), document.removeEventListener("keydown", M), P() && cordova.plugins.Keyboard.close()
        }, show: function () {
            P() && cordova.plugins.Keyboard.show()
        }
    }, ionic.Platform.ready(function () {
        x(), setTimeout(x, 999), window.navigator.msPointerEnabled ? document.addEventListener("MSPointerDown", S, !1) : document.addEventListener("touchstart", S, !1)
    });
    var rt, ot = {};
    ionic.viewport = {
    ...
    !function (e) {
        ...
        st.effect.Animate = {
            requestAnimationFrame: function () {
                ...
                var i = 60, r = {}, o = 0, s = 1, a = null, l = +new Date;
                return function (e) {
                    var t = s++;
                    return r[t] = e, o++, null === a && (a = setInterval(function () {
                        var e = +new Date, t = r;
                        r = {}, o = 0;
                ...
                var d = t(), _ = d, h = 0, f = 0, p = o++;
                if (u || (u = document.body), p % 20 === 0) {
                    var m = {};
                    for (var g in r)m[g] = !0;
                    r = m
                }
                var v = function (o) {
                    var m = o !== !0, g = t();
                    if (!r[p] || s && !s(p))return r[p] = null, void(a && a(n - f / ((g - d) / i), p, !1));
                    if (m)for (var T = Math.round((g - _) / (i / n)) - 1, E = 0; E < Math.min(T, 4); E++)v(!0), f++;
                    l && (h = (g - d) / l, h > 1 && (h = 1));
                    var S = c ? c(h) : h;
                    e(S, g, m) !== !1 && 1 !== h || !m ? m && (_ = g, st.effect.Animate.requestAnimationFrame(v, u)) : (r[p] = null, a && a(n - f / ((g - d) / i), p, 1 === h || null == l))
                };
                return r[p] = !0, st.effect.Animate.requestAnimationFrame(v, u), p
            }
        }
    }(this);
    !function (e) {
        ...
        e.views.Scroll = e.views.View.inherit({
            ...
            __initEventHandlers: function () {
                ...
                if (n.scrollChildIntoView = function (t) {
                        var r;
                        if (!n.isScrolledIntoView) {
                            if (e.Platform.isIOS() || e.Platform.isFullScreen) {
                                r = i.getBoundingClientRect().bottom;
                                var o = t.detail.viewportHeight - r, s = Math.max(0, t.detail.keyboardHeight - o);
                                i.style.height = i.clientHeight - s + "px", i.style.overflow = "visible", n.resize()
                            }
                            n.isScrolledIntoView = !0
                        }
                        if (t.detail.isElementUnderKeyboard) {
                            var a;
                            a = e.Platform.isAndroid() && !e.Platform.isFullScreen ? e.Platform.version() < 4.4 ? 500 : 350 : 80, e.scroll.isScrolling = !0, setTimeout(function () {
                                var o = .5 * i.clientHeight;
                                r = i.getBoundingClientRect().bottom;
                                var s = t.detail.elementTop - r, a = s + o;
                                a > 0 && (e.tap.cloneFocusedInput(i, n), n.scrollBy(0, a, !0), n.onScroll())
                            }, a)
                        }
                        t.stopPropagation()
                    ...
                    }, i.addEventListener("scrollChildIntoView", n.scrollChildIntoView), i.addEventListener("resetScrollView", n.resetScrollView), n.touchStart = function (i) {
                        if (n.startCoordinates = e.tap.pointerCoord(i), !e.tap.ignoreScrollStart(i)) {
                            if (n.__isDown = !0, e.tap.containsOrIsTextInput(i.target) || "SELECT" === i.target.tagName)return void(n.__hasStarted = !1);
                            n.__isSelectable = !0, n.__enableScrollY = !0, n.__hasStarted = !0, n.doTouchStart(t(i), i.timeStamp), i.preventDefault()
                        }
                    }, n.touchMove = function (r) {
                        if (!(n.options.freeze || !n.__isDown || !n.__isDown && r.defaultPrevented || "TEXTAREA" === r.target.tagName && r.target.parentElement.querySelector(":focus"))) {
                            if (!n.__hasStarted && (e.tap.containsOrIsTextInput(r.target) || "SELECT" === r.target.tagName))return n.__hasStarted = !0, n.doTouchStart(t(r), r.timeStamp), void r.preventDefault();
                            if (n.startCoordinates) {
                                var o = e.tap.pointerCoord(r);
                                n.__isSelectable && e.tap.isTextInput(r.target) && Math.abs(n.startCoordinates.x - o.x) > 20 && (n.__enableScrollY = !1, n.__isSelectable = !0), n.__enableScrollY && Math.abs(n.startCoordinates.y - o.y) > 10 && (n.__isSelectable = !1, e.tap.cloneFocusedInput(i, n))
                            }
                            n.doTouchMove(t(r), r.timeStamp, r.scale), n.__isDown = !0
                        }
                    }, n.touchMoveBubble = function (e) {
                        n.__isDown && n.options.preventDefault && e.preventDefault()
                    }, n.touchEnd = function (t) {
                        n.__isDown && (n.doTouchEnd(t, t.timeStamp), n.__isDown = !1, n.__hasStarted = !1, n.__isSelectable = !0, n.__enableScrollY = !0, n.__isDragging || n.__isDecelerating || n.__isAnimating || e.tap.removeClonedInputs(i, n))
                    }, n.mouseWheel = e.animationFrameThrottle(function (t) {
                        var i = e.DomUtil.getParentOrSelfWithClass(t.target, "ionic-scroll");
                        n.options.freeze || i !== n.__container || (n.hintResize(), n.scrollBy((t.wheelDeltaX || t.deltaX || 0) / n.options.wheelDampen, (-t.wheelDeltaY || t.deltaY || 0) / n.options.wheelDampen), n.__fadeScrollbars("in"), clearTimeout(n.__wheelHideBarTimeout), n.__wheelHideBarTimeout = setTimeout(function () {
                            n.__fadeScrollbars("out")
                        }, 100))
                    }), "ontouchstart"in window)i.addEventListener("touchstart", n.touchStart, !1), n.options.preventDefault && i.addEventListener("touchmove", n.touchMoveBubble, !1), document.addEventListener("touchmove", n.touchMove, !1), document.addEventListener("touchend", n.touchEnd, !1), document.addEventListener("touchcancel", n.touchEnd, !1); else if (window.navigator.pointerEnabled)i.addEventListener("pointerdown", n.touchStart, !1), n.options.preventDefault && i.addEventListener("pointermove", n.touchMoveBubble, !1), document.addEventListener("pointermove", n.touchMove, !1), document.addEventListener("pointerup", n.touchEnd, !1), document.addEventListener("pointercancel", n.touchEnd, !1), document.addEventListener("wheel", n.mouseWheel, !1); else if (window.navigator.msPointerEnabled)i.addEventListener("MSPointerDown", n.touchStart, !1), n.options.preventDefault && i.addEventListener("MSPointerMove", n.touchMoveBubble, !1), document.addEventListener("MSPointerMove", n.touchMove, !1), document.addEventListener("MSPointerUp", n.touchEnd, !1), document.addEventListener("MSPointerCancel", n.touchEnd, !1), document.addEventListener("wheel", n.mouseWheel, !1); else {
                    var r = !1;
                    n.mouseDown = function (i) {
                        e.tap.ignoreScrollStart(i) || "SELECT" === i.target.tagName || (n.doTouchStart(t(i), i.timeStamp), e.tap.isTextInput(i.target) || i.preventDefault(), r = !0)
                    }, n.mouseMove = function (e) {
                        n.options.freeze || !r || !r && e.defaultPrevented || (n.doTouchMove(t(e), e.timeStamp), r = !0)
                    }, n.mouseMoveBubble = function (e) {
                        r && n.options.preventDefault && e.preventDefault()
                    }, n.mouseUp = function (e) {
                        r && (n.doTouchEnd(e, e.timeStamp), r = !1)
                    }, i.addEventListener("mousedown", n.mouseDown, !1), n.options.preventDefault && i.addEventListener("mousemove", n.mouseMoveBubble, !1), document.addEventListener("mousemove", n.mouseMove, !1), document.addEventListener("mouseup", n.mouseUp, !1), document.addEventListener("mousewheel", n.mouseWheel, !1), document.addEventListener("wheel", n.mouseWheel, !1)
                }
            },
            __cleanup: function () {
                var n = this, i = n.__container;
            ...
            __createScrollbar: function (e) {
                ...
                return n.className = "scroll-bar-indicator scroll-bar-fade-out", t.className = "h" == e ? "scroll-bar scroll-bar-h" : "scroll-bar scroll-bar-v", t.appendChild(n), t
            },
            ...
            __repositionScrollbars: function () {
                var e, t, n, i, r, o = this, s = 0, a = 0;
                if (o.__indicatorX) {
                    o.__indicatorY && (s = 10), i = Math.round(o.__indicatorX.sizeRatio * o.__scrollLeft) || 0, t = o.__scrollLeft - (o.__maxScrollLeft - s), o.__scrollLeft < 0 ? (widthScale = Math.max(o.__indicatorX.minScale, (o.__indicatorX.size - Math.abs(o.__scrollLeft)) / o.__indicatorX.size), i = 0, o.__indicatorX.indicator.style[o.__transformOriginProperty] = "left center") : t > 0 ? (widthScale = Math.max(o.__indicatorX.minScale, (o.__indicatorX.size - t) / o.__indicatorX.size), i = o.__indicatorX.maxPos - s, o.__indicatorX.indicator.style[o.__transformOriginProperty] = "right center") : (i = Math.min(o.__maxScrollLeft, Math.max(0, i)), widthScale = 1);
                    var l = "translate3d(" + i + "px, 0, 0) scaleX(" + widthScale + ")";
                    o.__indicatorX.transformProp !== l && (o.__indicatorX.indicator.style[o.__transformProperty] = l, o.__indicatorX.transformProp = l)
                }
                if (o.__indicatorY) {
                    r = Math.round(o.__indicatorY.sizeRatio * o.__scrollTop) || 0, o.__indicatorX && (a = 10), n = o.__scrollTop - (o.__maxScrollTop - a), o.__scrollTop < 0 ? (e = Math.max(o.__indicatorY.minScale, (o.__indicatorY.size - Math.abs(o.__scrollTop)) / o.__indicatorY.size), r = 0, "center top" !== o.__indicatorY.originProp && (o.__indicatorY.indicator.style[o.__transformOriginProperty] = "center top", o.__indicatorY.originProp = "center top")) : n > 0 ? (e = Math.max(o.__indicatorY.minScale, (o.__indicatorY.size - n) / o.__indicatorY.size), r = o.__indicatorY.maxPos - a, "center bottom" !== o.__indicatorY.originProp && (o.__indicatorY.indicator.style[o.__transformOriginProperty] = "center bottom", o.__indicatorY.originProp = "center bottom")) : (r = Math.min(o.__maxScrollTop, Math.max(0, r)), e = 1);
                    var c = "translate3d(0," + r + "px, 0) scaleY(" + e + ")";
                    o.__indicatorY.transformProp !== c && (o.__indicatorY.indicator.style[o.__transformProperty] = c, o.__indicatorY.transformProp = c)
                }
            },
            ...
            getRenderFn: function () {
                ...
                var r, o = {
                    ...
                    webkit: "Webkit",
                    presto: "O"
                }[e], s = document.createElement("div"), a = o + "Perspective", l = o + "Transform", c = o + "TransformOrigin";
                return t.__perspectiveProperty = l, t.__transformProperty = l, t.__transformOriginProperty = c, s.style[a] !== r ? function (e, i, r, o) {
                    var s = "translate3d(" + -e + "px," + -i + "px,0) scale(" + r + ")";
                    s !== t.contentTransform && (n.style[l] = s, t.contentTransform = s), t.__repositionScrollbars(), o || t.triggerScrollEvent()
                } : s.style[l] !== r ? function (e, i, r, o) {
                    n.style[l] = "translate(" + -e + "px," + -i + "px) scale(" + r + ")", t.__repositionScrollbars(), o || t.triggerScrollEvent()
                } : function (e, i, r, o) {
            ...
            zoomTo: function (e, t, n, i) {
                ...
                r.__isDecelerating && (st.effect.Animate.stop(r.__isDecelerating), r.__isDecelerating = !1);
                var o = r.__zoomLevel;
                ...
                var s = (n + r.__scrollLeft) * e / o - n, a = (i + r.__scrollTop) * e / o - i;
                s > r.__maxScrollLeft ? s = r.__maxScrollLeft : 0 > s && (s = 0), a > r.__maxScrollTop ? a = r.__maxScrollTop : 0 > a && (a = 0), r.__publish(s, a, e, t)
            },
            ...
            scrollTo: function (e, t, n, i, r) {
                var o = this;
                if (o.__isDecelerating && (st.effect.Animate.stop(o.__isDecelerating), o.__isDecelerating = !1), null != i && i !== o.__zoomLevel) {
            ...
            doTouchStart: function (e, t) {
                var n = this;
                n.__decStopped = !(!n.__isDecelerating && !n.__isAnimating), n.hintResize(), t instanceof Date && (t = t.valueOf()), "number" != typeof t && (t = Date.now()), n.__interruptedAnimation = !0, n.__isDecelerating && (st.effect.Animate.stop(n.__isDecelerating), n.__isDecelerating = !1, n.__interruptedAnimation = !0), n.__isAnimating && (st.effect.Animate.stop(n.__isAnimating), n.__isAnimating = !1, n.__interruptedAnimation = !0);
            ...
            doTouchMove: function (e, t, n) {
                ...
                if (i.__isTracking) {
                    ...
                    if (i.__isDragging) {
                        i.__decStopped = !1;
                        var a = r - i.__lastTouchLeft, l = o - i.__lastTouchTop, c = i.__scrollLeft, u = i.__scrollTop, d = i.__zoomLevel;
                        if (null != n && i.options.zooming) {
                            var _ = d;
                            if (d = d / i.__lastScale * n, d = Math.max(Math.min(d, i.options.maxZoom), i.options.minZoom), _ !== d) {
                                var h = r - i.__clientLeft, f = o - i.__clientTop;
                                c = (h + c) * d / _ - h, u = (f + u) * d / _ - f, i.__computeScrollMax(d)
                            }
                        }
                        if (i.__enableScrollX) {
                            c -= a * i.options.speedMultiplier;
                            var p = i.__maxScrollLeft;
                            (c > p || 0 > c) && (i.options.bouncing ? c += a / 2 * i.options.speedMultiplier : c = c > p ? p : 0)
                        }
                        ...
                        var g = i.options.locking ? 3 : 0, v = 5, T = Math.abs(r - i.__initialTouchLeft), E = Math.abs(o - i.__initialTouchTop);
                        i.__enableScrollX = i.options.scrollingX && T >= g, i.__enableScrollY = i.options.scrollingY && E >= g, s.push(i.__scrollLeft, i.__scrollTop, t), i.__isDragging = (i.__enableScrollX || i.__enableScrollY) && (T >= v || E >= v), i.__isDragging && (i.__interruptedAnimation = !1, i.__fadeScrollbars("in"))
                    }
            ...
            doTouchEnd: function (t, n) {
                ...
                if (i.__isTracking) {
                    if (i.__isTracking = !1, i.__isDragging)if (i.__isDragging = !1, i.__isSingleTouch && i.options.animating && n - i.__lastTouchMove <= 100) {
                        for (var r = i.__positions, o = r.length - 1, s = o, a = o; a > 0 && r[a] > i.__lastTouchMove - 100; a -= 3)s = a;
                        if (s !== o) {
                            var l = r[o] - r[s], c = i.__scrollLeft - r[s - 2], u = i.__scrollTop - r[s - 1];
                            i.__decelerationVelocityX = c / l * (1e3 / 60), i.__decelerationVelocityY = u / l * (1e3 / 60);
                    ...
                    if (!i.__isDecelerating)if (i.__refreshActive && i.__refreshStart) {
                        ...
                        var _ = new Date;
                        i.refreshStartTime = _.getTime(), i.__refreshStart && i.__refreshStart(), e.Platform.isAndroid() || i.__startDeceleration()
            ...
            __publish: function (e, t, r, o, s) {
                var a = this, l = a.__isAnimating;
                if (l && (st.effect.Animate.stop(l), a.__isAnimating = !1), o && a.options.animating) {
                    a.__scheduledLeft = e, a.__scheduledTop = t, a.__scheduledZoom = r;
                    var c = a.__scrollLeft, u = a.__scrollTop, d = a.__zoomLevel, _ = e - c, h = t - u, f = r - d, p = function (e, t, n) {
                    ...
                    a.__isAnimating = st.effect.Animate.start(p, m, g, a.options.animationDuration, l ? n : i)
                } else a.__scheduledLeft = a.__scrollLeft = e, a.__scheduledTop = a.__scrollTop = t, a.__scheduledZoom = a.__zoomLevel = r, a.__callback && a.__callback(e, t, r, s), a.options.zooming && a.__computeScrollMax()
            },
            ...
            __startDeceleration: function () {
                ...
                e.__isDecelerating = st.effect.Animate.start(o, s, a)
            },
            __stepThroughDeceleration: function (e) {
                ...
                if (e ? t.__publish(n, i, t.__zoomLevel) : (t.__scrollLeft = n, t.__scrollTop = i), !t.options.paging) {
                    ...
                    t.__decelerationVelocityX *= s, t.__decelerationVelocityY *= s
                }
                if (t.options.bouncing) {
                    var a = 0, l = 0, c = t.options.penetrationDeceleration, u = t.options.penetrationAcceleration;
                    if (n < t.__minDecelerationScrollLeft ? a = t.__minDecelerationScrollLeft - n : n > t.__maxDecelerationScrollLeft && (a = t.__maxDecelerationScrollLeft - n), i < t.__minDecelerationScrollTop ? l = t.__minDecelerationScrollTop - i : i > t.__maxDecelerationScrollTop && (l = t.__maxDecelerationScrollTop - i), 0 !== a) {
                        ...
                        var _ = Math.abs(t.__decelerationVelocityX) <= t.__minVelocityToKeepDecelerating;
                        (!d || _) && (t.__decelerationVelocityX = a * u)
                    }
                    if (0 !== l) {
                        ...
                        (!h || f) && (t.__decelerationVelocityY = l * u)
                    }
                }
            },
        ...
        "use strict";
        var t = "item", n = "item-content", i = "item-sliding", r = "item-options", o = "item-placeholder", s = "item-reordering", a = "item-reorder", l = function () {
        };
        l.prototype = {
            start: function () {
            }, drag: function () {
        ...
        u.prototype = new l, u.prototype._moveElement = function (t) {
            ...
            r.classList.add(o), this.el.parentNode.insertBefore(r, this.el), this.el.classList.add(s), this._currentDrag = {
                elementHeight: i,
                startIndex: n,
                placeholder: r,
                scrollHeight: scroll,
            ...
            if (this._currentDrag) {
                ...
                if (this.scrollView) {
                    ...
                    var a = s.offsetTop, l = a - r + this._currentDrag.elementHeight / 2, c = r + this._currentDrag.elementHeight / 2 - a - s.offsetHeight;
            ...
            for (var e, t = this, n = (t._currentDrag.placeholder, Array.prototype.slice.call(t._currentDrag.placeholder.parentNode.children).filter(function (e) {
                return e.nodeName === t.el.nodeName && e !== t.el
            })), i = t._currentDrag.currentY, r = 0, o = n.length; o > r; r++)if (e = n[r], r === o - 1) {
            ...
            this.el.classList.remove(s), this.el.style[e.CSS.TRANSFORM] = "", i.parentNode.insertBefore(this.el, i), i.parentNode.removeChild(i), this.onReorder && this.onReorder(this.el, this._currentDrag.startIndex, r), this._currentDrag = {
                placeholder: null,
                content: null
            ...
            initialize: function (t) {
                ...
                t = e.extend({
                    ...
                    n._handleEndDrag(e)
                }, n.el), window.ionic.onGesture("drag", function (e) {
                    n._handleDrag(e)
                }, n.el), n._initDrag()
            }, deregister: function () {
                ...
                var t = this;
                if (t.isVirtual) {
                    var n = t.itemHeight, i = (t.listEl.children.length, e.target.scrollHeight), r = t.el.parentNode.offsetHeight, o = (e.scrollTop, Math.max(0, e.scrollTop + t.virtualRemoveThreshold)), s = Math.min(i, Math.abs(e.scrollTop) + r + t.virtualAddThreshold), a = Math.floor((s - o) / n), l = parseInt(Math.abs(o / n), 10), c = parseInt(Math.abs(s / n), 10);
                    t._virtualItemsToRemove = Array.prototype.slice.call(t.listEl.children, 0, l);
                    {
                        Array.prototype.slice.call(t.listEl.children, l, l + a)
                    }
                    t.renderViewport && t.renderViewport(o, s, l, c)
                }
            }, didStopScrolling: function () {
                if (this.isVirtual)for (var e = 0; e < this._virtualItemsToRemove.length; e++) {
                    {
                        this._virtualItemsToRemove[e]
                    }
        ...
        e.views.Slider = e.views.View.inherit({
            initialize: function (e) {
                function t() {
                    m = E.children, T = m.length, m.length < 2 && (e.continuous = !1), f.transitions && e.continuous && m.length < 3 && (E.appendChild(m[0].cloneNode(!0)), E.appendChild(E.children[1].cloneNode(!0)), m = E.children), g = new Array(m.length), v = p.offsetWidth || p.getBoundingClientRect().width, E.style.width = m.length * v + "px";
                    for (var t = m.length; t--;) {
                        var n = m[t];
                        n.style.width = v + "px", n.setAttribute("data-index", t), f.transitions && (n.style.left = t * -v + "px", s(t, S > t ? -v : t > S ? v : 0, 0))
                    }
                    e.continuous && f.transitions && (s(r(S - 1), -v, 0), s(r(S + 1), v, 0)), f.transitions || (E.style.left = S * -v + "px"), p.style.visibility = "visible", e.slidesChanged && e.slidesChanged()
                }

                function n() {
                    e.continuous ? o(S - 1) : S && o(S - 1)
                }

                function i() {
                    e.continuous ? o(S + 1) : S < m.length - 1 && o(S + 1)
                }
                ...
                function o(t, n) {
                    if (S != t) {
                        if (f.transitions) {
                            ...
                            if (e.continuous) {
                                var o = i;
                                i = -g[r(t)] / v, i !== o && (t = -i * m.length + t)
                            }
                            for (var a = Math.abs(S - t) - 1; a--;)s(r((t > S ? t : S) - a - 1), v * i, 0);
                            t = r(t), s(S, v * i, n || b), s(t, 0, n || b), e.continuous && s(r(t - i), -(v * i), 0)
                        } else t = r(t), l(S * -v, t * -v, n || b);
                        S = t, h(e.callback && e.callback(S, m[S]))
                    }
                }
                ...
                function l(t, n, i) {
                    ...
                    var r = +new Date, o = setInterval(function () {
                        var s = +new Date - r;
                        return s > i ? (E.style.left = n + "px", D && c(), e.transitionEnd && e.transitionEnd.call(event, S, m[S]), void clearInterval(o)) : void(E.style.left = (n - t) * (Math.floor(s / i * 100) / 100) + t + "px")
                    }, 4)
                }
                ...
                if (p) {
                    ...
                    e = e || {};
                    var S = parseInt(e.startSlide, 10) || 0, b = e.speed || 300;
                    e.continuous = void 0 !== e.continuous ? e.continuous : !0;
                    var w, y, D = e.auto || 0, L = {}, x = {}, M = {
                        handleEvent: function (n) {
                            ...
                            L = {
                                ...
                                y: t.pageY,
                                time: +new Date
                            }, y = void 0, x = {}, f.touch ? (E.addEventListener("touchmove", this, !1), E.addEventListener("touchend", this, !1)) : (E.addEventListener("mousemove", this, !1), E.addEventListener("mouseup", this, !1), document.addEventListener("mouseup", this, !1))
                            ...
                            if (!(t.touches.length > 1 || t.scale && 1 !== t.scale || d.slideIsDisabled)) {
                                ...
                                x = {
                                    x: n.pageX - L.x,
                                    y: n.pageY - L.y
                                }, "undefined" == typeof y && (y = !!(y || Math.abs(x.x) < Math.abs(x.y))), y || (t.preventDefault(), u(), e.continuous ? (a(r(S - 1), x.x + g[r(S - 1)], 0), a(S, x.x + g[S], 0), a(r(S + 1), x.x + g[r(S + 1)], 0)) : (x.x = x.x / (!S && x.x > 0 || S == m.length - 1 && x.x < 0 ? Math.abs(x.x) / v + 1 : 1), a(S - 1, x.x + g[S - 1], 0), a(S, x.x + g[S], 0), a(S + 1, x.x + g[S + 1], 0)))
                            }
                        }, end: function () {
                            var t = +new Date - L.time, n = Number(t) < 250 && Math.abs(x.x) > 20 || Math.abs(x.x) > v / 2, i = !S && x.x > 0 || S == m.length - 1 && x.x < 0;
                            e.continuous && (i = !1);
                            var o = x.x < 0;
                            y || (n && !i ? (o ? (e.continuous ? (s(r(S - 1), -v, 0), s(r(S + 2), v, 0)) : s(S - 1, -v, 0), s(S, g[S] - v, b), s(r(S + 1), g[r(S + 1)] - v, b), S = r(S + 1)) : (e.continuous ? (s(r(S + 1), v, 0), s(r(S - 2), -v, 0)) : s(S + 1, v, 0), s(S, g[S] + v, b), s(r(S - 1), g[r(S - 1)] + v, b), S = r(S - 1)), e.callback && e.callback(S, m[S])) : e.continuous ? (s(r(S - 1), -v, b), s(S, 0, b), s(r(S + 1), v, b)) : (s(S - 1, -v, b), s(S, 0, b), s(S + 1, v, b))), f.touch ? (E.removeEventListener("touchmove", M, !1), E.removeEventListener("touchend", M, !1)) : (E.removeEventListener("mousemove", M, !1), E.removeEventListener("mouseup", M, !1), document.removeEventListener("mouseup", M, !1))
        ...
        e.views.Toggle = e.views.View.inherit({
            initialize: function (t) {
                ...
                this._dragInfo && (t.gesture.srcEvent.preventDefault(), e.requestAnimationFrame(function () {
                    if (n._dragInfo) {
                        var e = (n.track.offsetLeft + n.handle.offsetWidth / 2, n.track.offsetLeft + n.track.offsetWidth - n.handle.offsetWidth / 2, t.gesture.deltaX, t.gesture.touches[0].pageX - n._dragInfo.left), i = n._dragInfo.width - n.triggerThreshold;
        ...
        X.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", "$$jqLite", function (O, N, M, Y, y, H, P, W, Z, Q) {
            ...
            function U(a, c, b, d) {
                function h(e, a) {
                    ...
                    if (b || c)return "leave" == a && (c = b, b = null), u.push({event: a, fn: b}), J.push({
                        event: a,
                        fn: c
                    }),
                        !0
            ...
            function G(a, c, b, d, h, k, l, e) {
                ...
                if (0 < s) {
                    ...
                    if (m.isClassBased)"setClass" == q.event ?
                        (s.push(q), B(b, c)) : L[c] && (v = L[c], v.event == a ? h = !0 : (s.push(v), B(b, c))); else if ("leave" == a && L["ng-leave"])h = !0; else {
...
(function (n, h, p) {
    ...
    function F(a, d) {
        ...
        for (f.last = function () {
            ...
            l = "";
            k = !0;
            if (f.last() && x[f.last()])a = a.replace(new RegExp("([\\W\\w]*)<\\s*\\/\\s*" + f.last() + "[^>]*>", "i"), function (a, b) {
                b = b.replace(H, "$1").replace(I, "$1");
                d.chars && d.chars(r(b));
                return ""
            }), e("", f.last()); else {
                if (0 === a.indexOf("\x3c!--"))b = a.indexOf("--", 4), 0 <= b && a.lastIndexOf("--\x3e", b) === b && (d.comment &&
                d.comment(a.substring(4, b)), a = a.substring(b + 3), k = !1); else if (y.test(a)) {
    ...
    function r(a) {
        ...
        a = d[1];
        var c = d[3];
        if (d = d[2])q.innerHTML = d.replace(/</g, "&lt;"), d = "textContent"in q ? q.textContent : q.innerText;
        return a + d + c
    }
    ...
    var L = h.$$minErr("$sanitize"), A = /^<((?:[a-zA-Z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*(>?)/, z = /^<\/\s*([\w:-]+)[^>]*>/, G = /([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,
        K = /^</, J = /^<\//, H = /\x3c!--(.*?)--\x3e/g, y = /<!DOCTYPE([^>]*?)>/i, I = /<!\[CDATA\[(.*?)]]\x3e/g, N = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g, O = /([^\#-~| |!])/g, w = g("area,br,col,hr,img,wbr");
...
!function () {
        ...
        function a(i, a, c, s, l) {
            ...
            function h() {
                return C || (C = new e({
                        ...
                        heightData: x,
                        widthData: A,
                        forceRefreshImages: !(!f(c.forceRefreshImages) || "false" === c.forceRefreshImages),
                        keyExpression: T,
                        renderBuffer: L,
                        scope: i,
            ...
            function p() {
                ...
                if (!e.length) {
                    var t = !1, n = [].filter.call(w.__content.childNodes, function (e) {
                        return ionic.DomUtil.contains(e, y) ? (t = !0, !1) : t
                    });
                    e = angular.element('<span class="collection-repeat-after-container">'), w.options.scrollingX && e.addClass("horizontal"), e.append(n), w.__content.appendChild(e[0])
                }
                return e
            }

            function v() {
                _ || R ? (_ ? m(_, x) : x.computed = !0, R || (R = '"100%"'), m(R, A)) : x.computed = A.computed = !0
            }

            function g() {
                var e = P.length > 0;
                if (e && (x.computed || A.computed) && $(), e && x.computed) {
                    if (x.value = V.height, !x.value)throw new Error('collection-repeat tried to compute the height of repeated elements "' + S + '", but was unable to. Please provide the "item-height" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/')
                } else!x.dynamic && x.getValue && (x.value = x.getValue());
                if (e && A.computed) {
                    if (A.value = V.width, !A.value)throw new Error('collection-repeat tried to compute the width of repeated elements "' + S + '", but was unable to. Please provide the "item-width" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/')
            ...
            function $() {
                z || l(O = i.$new(), function (e) {
                    e[0].removeAttribute("collection-repeat"), z = e[0]
                }), O[T] = (I(i) || [])[0], o.$$phase || O.$digest(), y.appendChild(z);
                var e = n.getComputedStyle(z);
                V.width = parseInt(e.width), V.height = parseInt(e.height), y.removeChild(z)
            }

            var w = s.scrollView, b = a[0], y = angular.element('<div class="collection-repeat-container">')[0];
            ...
            var S = c.collectionRepeat, k = S.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);
            if (!k)throw new Error("collection-repeat expected expression in form of '_item_ in _collection_[ track by _id_]' but got '" + c.collectionRepeat + "'.");
            var C, T = k[1], B = k[2], I = t(B), x = {}, A = {}, V = {}, P = [], D = c.itemRenderBuffer || c.collectionBufferSize, L = angular.isDefined(D) ? parseInt(D) : E, _ = c.itemHeight || c.collectionItemHeight, R = c.itemWidth || c.collectionItemWidth, M = p(), N = d();
            v(), s.$element.on("scroll.resize", g), angular.element(n).on("resize", u);
            var H = o.$on("$ionicExposeAside", u);
            r(g, 0, !1), i.$watchCollection(I, function (e) {
                ...
                angular.element(n).off("resize", u), H(), s.$element && s.$element.off("scroll.resize", g), z && z.parentNode && z.parentNode.removeChild(z), O && O.$destroy(), O = z = null, C && C.destroy(), C = null
            });
            var z, O
        }
    ...
    function t(e, t, n) {
        var o = {primaryPos: 0, secondaryPos: 0, primarySize: 0, secondarySize: 0};
        return function (r) {
            function a() {
                return c(!0)
            }
            ...
            function l() {
                var e = this;
                this.scope = T.$new(), this.id = "item" + Q++, I(this.scope, function (t) {
                    e.element = t, e.element.data("$$collectionRepeatItem", e), e.node = t[0], e.node.style[ionic.CSS.TRANSFORM] = "translate3d(-9999px,-9999px,0)", e.node.style.cssText += " height: 0px; width: 0px;", ionic.Utils.disconnectScope(e.scope), w.appendChild(e.node), e.images = t[0].getElementsByTagName("img")
                })
            }

            function u() {
                this.getItemPrimarySize = D, this.getItemSecondarySize = _, this.getScrollValue = function () {
                    return Math.max(0, Math.min(B.__scrollTop - q, B.__maxScrollTop - q - F))
                }, this.refreshDirection = function () {
                    this.scrollPrimarySize = B.__clientHeight, this.scrollSecondarySize = B.__clientWidth, this.estimatedPrimarySize = g, this.estimatedSecondarySize = m, this.estimatedItemsAcross = M && Math.floor(B.__clientWidth / m) || 1
                }
            }

            function d() {
                this.getItemPrimarySize = _, this.getItemSecondarySize = D, this.getScrollValue = function () {
                    return Math.max(0, Math.min(B.__scrollLeft - q, B.__maxScrollLeft - q - F))
                }, this.refreshDirection = function () {
                    this.scrollPrimarySize = B.__clientWidth, this.scrollSecondarySize = B.__clientHeight, this.estimatedPrimarySize = m, this.estimatedSecondarySize = g, this.estimatedItemsAcross = M && Math.floor(B.__clientHeight / g) || 1
                }
            }
            ...
            function p() {
                this.getContentSize = function () {
                    return this.getEstimatedPrimaryPos(E.length - 1) + this.estimatedPrimarySize + q + F
                };
                var e = {};
                this.getDimensions = function (t) {
                    ...
                    W = Math.max(0, this.getEstimatedIndex(e)), X = Math.min(E.length - 1, this.getEstimatedIndex(t) + this.estimatedItemsAcross - 1), G = Math.max(0, this.getEstimatedPrimaryPos(W)), Y = this.getEstimatedPrimaryPos(X) + this.estimatedPrimarySize
                }
            }
            ...
            function v() {
                function e(e) {
                    var t, i, a;
                    for (t = Math.max(0, n); e >= t && (a = s[t]); t++)i = s[t - 1] || o, a.primarySize = r.getItemPrimarySize(t, E[t]), a.secondarySize = r.scrollSecondarySize, a.primaryPos = i.primaryPos + i.primarySize, a.secondaryPos = 0
                }

                function t(e) {
                    var t, i, a;
                    for (t = Math.max(n, 0); e >= t && (a = s[t]); t++)i = s[t - 1] || o, a.secondarySize = Math.min(r.getItemSecondarySize(t, E[t]), r.scrollSecondarySize), a.secondaryPos = i.secondaryPos + i.secondarySize, 0 === t || a.secondaryPos + a.secondarySize > r.scrollSecondarySize ? (a.rowStartIndex = t, a.secondaryPos = 0, a.primarySize = r.getItemPrimarySize(t, E[t]), a.primaryPos = i.primaryPos + i.primarySize) : (a.rowStartIndex = i.rowStartIndex, a.primarySize = i.primarySize, a.primaryPos = i.primaryPos)
                }

                var n, r = this, a = ionic.debounce(et, 25, !0), c = M ? t : e, s = [];
                this.getContentSize = function () {
                    var e = s[n] || o;
                    return (e.primaryPos + e.primarySize || 0) + this.getEstimatedPrimaryPos(E.length - n - 1) + q + F
                }, this.onDestroy = function () {
                    s.length = 0
                }, this.onRefreshData = function () {
                    for (i = s.length, len = E.length; i < len; i++)s.push({});
                    n = -1
                }, this.onRefreshLayout = function () {
                    n = -1
                }, this.getDimensions = function (e) {
                    return e = Math.min(e, E.length - 1), e > n && (e > .9 * E.length ? (c(E.length - 1), n = E.length - 1, et()) : (c(e), n = e, a())), s[e]
                };
                var l = -1, u = -1;
                this.updateRenderRange = function (e, t) {
                    var n, i, o;
                    if (this.getDimensions(2 * this.getEstimatedIndex(t)), -1 === l || 0 === e)n = 0; else if (e >= u)for (n = l, i = E.length; i > n && !((o = this.getDimensions(n)) && o.primaryPos + o.primarySize >= e); n++); else for (n = l; n >= 0; n--)if ((o = this.getDimensions(n)) && o.primaryPos <= e) {
                        n = M ? o.rowStartIndex : n;
                        break
                    }
                    W = Math.min(Math.max(0, n), E.length - 1), G = -1 !== W ? this.getDimensions(W).primaryPos : -1;
                    var r;
                    for (n = W + 1, i = E.length; i > n; n++)if ((o = this.getDimensions(n)) && o.primaryPos + o.primarySize > t) {
                        if (M)for (r = o; i - 1 > n && (o = this.getDimensions(n + 1)).primaryPos === r.primaryPos;)n++;
                        break
                    }
                    X = Math.min(n, E.length - 1), Y = -1 !== X ? (o = this.getDimensions(X)).primaryPos + o.primarySize : -1, u = e, l = W
                }
            }

            var g, m, $ = r.afterItemsNode, w = r.containerNode, b = r.forceRefreshImages, y = r.heightData, S = r.widthData, k = r.keyExpression, C = r.renderBuffer, T = r.scope, B = r.scrollView, I = r.transclude, E = [], V = {}, P = y.getValue || function () {
                    return y.value
                }, D = function (e, t) {
                return V[k] = t, V.$index = e, P(T, V)
            }, L = S.getValue || function () {
                    return S.value
                }, _ = function (e, t) {
                return V[k] = t, V.$index = e, L(T, V)
            }, R = !!B.options.scrollingY, M = R ? S.dynamic || S.value !== B.__clientWidth : y.dynamic || y.value !== B.__clientHeight, N = !y.dynamic && !S.dynamic, H = "PRIMARY", z = "SECONDARY", O = R ? "translate3d(SECONDARYpx,PRIMARYpx,0)" : "translate3d(PRIMARYpx,SECONDARYpx,0)", U = R ? "height: PRIMARYpx; width: SECONDARYpx;" : "height: SECONDARYpx; width: PRIMARYpx;", q = 0, F = 0, W = -1, X = -1, Y = -1, G = -1, j = [], Z = [], K = [], J = {}, Q = 0, et = R ? function () {
                B.setDimensions(null, null, null, tt.getContentSize(), !0)
            } : function () {
                B.setDimensions(null, null, tt.getContentSize(), null, !0)
            }, tt = R ? new u : new d;
            (M ? f : h).call(tt), (N ? p : v).call(tt);
            var nt = R ? "getContentHeight" : "getContentWidth", it = B.options[nt];
            B.options[nt] = angular.bind(tt, tt.getContentSize), B.__$callback = B.__callback, B.__callback = function (e, t, n, i) {
                var o = tt.getScrollValue();
                (-1 === W || o + tt.scrollPrimarySize > Y || G > o) && c(), B.__$callback(e, t, n, i)
            };
            var ot = !1, rt = !1;
            this.refreshLayout = function () {
                g = D(0, E[0]), m = _(0, E[0]);
                var e = getComputedStyle($) || {}, n = $.firstElementChild && getComputedStyle($.firstElementChild) || {}, i = $.lastElementChild && getComputedStyle($.lastElementChild) || {};
                F = (parseInt(e[R ? "height" : "width"]) || 0) + (n && parseInt(n[R ? "marginTop" : "marginLeft"]) || 0) + (i && parseInt(i[R ? "marginBottom" : "marginRight"]) || 0), q = 0;
                var o = w;
                do q += o[R ? "offsetTop" : "offsetLeft"]; while (ionic.DomUtil.contains(B.__content, o = o.offsetParent));
                var r = w.previousElementSibling, c = r ? t.getComputedStyle(r) : {}, s = parseInt(c[R ? "marginBottom" : "marginRight"] || 0);
                if (w.style[ionic.CSS.TRANSFORM] = O.replace(H, -s).replace(z, 0), q -= s, B.__clientHeight && B.__clientWidth || (B.__clientWidth = B.__container.clientWidth, B.__clientHeight = B.__container.clientHeight), (tt.onRefreshLayout || angular.noop)(), tt.refreshDirection(), et(), !ot)for (var u = Math.max(20, 3 * C), d = 0; u > d; d++)j.push(new l);
                ot = !0, ot && rt && ((B.__scrollLeft > B.__maxScrollLeft || B.__scrollTop > B.__maxScrollTop) && B.resize(), a(!0))
            }, this.setData = function (e) {
                E = e, (tt.onRefreshData || angular.noop)(), rt = !0
            }, this.destroy = function () {
                c.destroyed = !0, j.forEach(function (e) {
                    e.scope.$destroy(), e.scope = e.element = e.node = e.images = null
                }), j.length = K.length = Z.length = 0, J = {}, B.options[nt] = it, B.__callback = B.__$callback, B.resize(), (tt.onDestroy || angular.noop)()
            }
        }
    }
    ...
    var s = {
        method: function (e, t, n) {
            var i = !1;
            return function () {
                return i || (i = !0, t(e)), n.apply(this, arguments)
            }
        }, field: function (e, t, n, i, o) {
            var r = !1, a = function () {
                return r || (r = !0, t(e)), o
            }, c = function (n) {
                return r || (r = !0, t(e)), o = n, n
            };
            Object.defineProperty(n, i, {get: a, set: c, enumerable: !0})
        }
    }, l = angular.module("ionic", ["ngAnimate", "ngSanitize", "ui.router"]), u = angular.extend, d = angular.forEach, f = angular.isDefined, h = angular.isNumber, p = angular.isString, v = angular.element, g = angular.noop;
    l.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", function (e, t, n, i, o, r, a) {
        function c(o) {
            function c(e) {
                e && /icon/.test(e) && (s.$actionSheetHasIcon = !0)
            }

            var s = e.$new(!0);
            u(s, {
                cancel: g,
                destructiveButtonClicked: g,
                buttonClicked: g,
                $deregisterBackButton: g,
                buttons: [],
                cancelOnStateChange: !0
            }, o || {});
            for (var l = 0; l < s.buttons.length; l++)c(s.buttons[l].text);
            c(s.cancelText), c(s.destructiveText);
            var d = s.element = t('<ion-action-sheet ng-class="cssClass" buttons="buttons"></ion-action-sheet>')(s), f = v(d[0].querySelector(".action-sheet-wrapper")), h = s.cancelOnStateChange ? e.$on("$stateChangeSuccess", function () {
                s.cancel()
            }) : g;
            return s.removeSheet = function (e) {
                s.removed || (s.removed = !0, f.removeClass("action-sheet-up"), i(function () {
                    a.removeClass("action-sheet-open")
                }, 400), s.$deregisterBackButton(), h(), n.removeClass(d, "active").then(function () {
                    s.$destroy(), d.remove(), s.cancel.$scope = f = null, (e || g)()
                }))
            }, s.showSheet = function (e) {
                s.removed || (a.append(d).addClass("action-sheet-open"), n.addClass(d, "active").then(function () {
                    s.removed || (e || g)()
                }), i(function () {
                    s.removed || f.addClass("action-sheet-up")
                }, 20, !1))
            }, s.$deregisterBackButton = r.registerBackButtonAction(function () {
                i(s.cancel)
            }, C), s.cancel = function () {
                s.removeSheet(o.cancel)
            }, s.buttonClicked = function (e) {
                o.buttonClicked(e, o.buttons[e]) === !0 && s.removeSheet()
            }, s.destructiveButtonClicked = function () {
                o.destructiveButtonClicked() === !0 && s.removeSheet()
            }, s.showSheet(), s.cancel.$scope = s, s.cancel
        }
        ...
        return this
    }, l.factory("$ionicBackdrop", ["$document", "$timeout", function (e, t) {
        function n() {
            1 === ++a && (r.addClass("visible"), ionic.requestAnimationFrame(function () {
                a && r.addClass("active")
            }))
        }

        function i() {
            0 === --a && (r.removeClass("active"), t(function () {
                !a && r.removeClass("visible")
            }, 400, !1))
        }
        ...
        var r = v('<div class="backdrop">'), a = 0;
        return e[0].body.appendChild(r[0]), {retain: n, release: i, getElement: o, _element: r}
    }]), l.factory("$ionicBind", ["$parse", "$interpolate", function (e, t) {
        var n = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
    ...
    }]), l.factory("$ionicBody", ["$document", function (e) {
        return {
            addClass: function () {
    ...
    }]), l.factory("$ionicClickBlock", ["$document", "$ionicBody", "$timeout", function (e, t, n) {
        function i(e) {
        ...
        return {
            show: function (e) {
                s = !0, n.cancel(c), c = n(this.hide, e || 310), o()
            }, hide: function () {
                s = !1, n.cancel(c), r()
            }
        }
    }]), l.factory("$ionicGesture", [function () {
        return {
            on: function (e, t, n, i) {
    ...
    }]), l.factory("$ionicHistory", ["$rootScope", "$state", "$location", "$window", "$timeout", "$ionicViewSwitcher", "$ionicNavViewDelegate", function (e, t, n, i, o, r, a) {
        function c(e) {
            return e ? D.views[e] : null
        }
        ...
        function d(e) {
            return e ? D.histories[e] : null
        }

        function f(e) {
            var t = h(e);
            return D.histories[t.historyId] || (D.histories[t.historyId] = {
        ...
        function p(e) {
            D.currentView = c(e), D.backView = s(D.currentView), D.forwardView = l(D.currentView)
        }
        ...
        var $, w, b, y, S = "initialView", k = "newView", C = "moveBack", T = "moveForward", B = "back", I = "forward", x = "enter", A = "exit", E = "swap", V = "none", P = 0, D = {
            histories: {
                root: {
                    historyId: "root",
        ...
        return L.prototype.initialize = function (e) {
            ...
            return this.stateName ? t.go(this.stateName, this.stateParams) : this.url && this.url !== n.url() ? D.backView === this ? i.history.go(-1) : D.forwardView === this ? i.history.go(1) : void n.url(this.url) : null
        }, L.prototype.destroy = function () {
            this.scope && (this.scope.$destroy && this.scope.$destroy(), this.scope = null)
        }, {
            register: function (e, t) {
                var i, a, l, u = v(), m = f(e), L = D.currentView, _ = D.backView, R = D.forwardView, M = null, N = null, H = V, z = m.historyId, O = n.url();
                if ($ !== u && ($ = u, P++), y)M = y.viewId, N = y.action, H = y.direction, y = null; else if (_ && _.stateId === u)M = _.viewId, z = _.historyId, N = C, _.historyId === L.historyId ? H = B : L && (H = A, i = d(_.historyId), i && i.parentHistoryId === L.historyId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))); else if (R && R.stateId === u)M = R.viewId, z = R.historyId, N = T, R.historyId === L.historyId ? H = I : L && (H = A, L.historyId === m.parentHistoryId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))), i = h(e), R.historyId && i.scope && (i.scope.$historyId = R.historyId, z = R.historyId); else if (L && L.historyId !== z && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                    var U = m.stack[m.cursor];
                    M = U.viewId, z = U.historyId, N = C, H = E, i = d(L.historyId), i && i.parentHistoryId === z ? H = A : (i = d(z), i && i.parentHistoryId === L.historyId && (H = x)), i = c(U.backViewId), i && U.historyId !== i.historyId && (m.stack[m.cursor].backViewId = L.viewId)
                } else {
                    if (l = r.createViewEle(t), this.isAbstractEle(l, t))return {
                        action: "abstractView",
                        direction: V,
                        ele: l
                    };
                    if (M = ionic.Utils.nextUid(), L) {
                        if (L.forwardViewId = M, N = k, R && L.stateId !== R.stateId && L.historyId === R.historyId && (i = d(R.historyId))) {
                            for (a = i.stack.length - 1; a >= R.index; a--) {
                                var q = i.stack[a];
                                q && q.destroy && q.destroy(), i.stack.splice(a)
                            }
                            z = R.historyId
                        }
                        m.historyId === L.historyId ? H = I : L.historyId !== m.historyId && (H = x, i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId ? H = E : (i = d(i.parentHistoryId), i && i.historyId === m.historyId && (H = A)))
                    } else N = S;
                    2 > P && (H = V), D.views[M] = this.createView({
                        viewId: M,
                        index: m.stack.length,
                        historyId: m.historyId,
                        backViewId: L && L.viewId ? L.viewId : null,
                        forwardViewId: null,
                        stateId: u,
                        stateName: this.currentStateName(),
                        stateParams: g(),
                        url: O
                    }), m.stack.push(D.views[M])
                }
                if (o.cancel(b), w) {
                    if (w.disableAnimate && (H = V), w.disableBack && (D.views[M].backViewId = null), w.historyRoot) {
                        for (a = 0; a < m.stack.length; a++)m.stack[a].viewId === M ? (m.stack[a].index = 0, m.stack[a].backViewId = m.stack[a].forwardViewId = null) : delete D.views[m.stack[a].viewId];
                        m.stack = [D.views[M]]
                    }
                    w = null
                }
                if (p(M), D.backView && z == D.backView.historyId && u == D.backView.stateId && O == D.backView.url)for (a = 0; a < m.stack.length; a++)if (m.stack[a].viewId == M) {
                    N = "dupNav", H = V, a > 0 && (m.stack[a - 1].forwardViewId = null), D.forwardView = null, D.currentView.index = D.backView.index, D.currentView.backViewId = D.backView.backViewId, D.backView = s(D.backView), m.stack.splice(a, 1);
                    break
                }
                return m.cursor = D.currentView.index, {
                    viewId: M,
                    action: N,
                    direction: H,
                    historyId: z,
                    enableBack: this.enabledBack(D.currentView),
                    isHistoryRoot: 0 === D.currentView.index,
                    ele: l
                }
            ...
            }, getViewById: c, viewHistory: function () {
                return D
            }, currentView: function (e) {
                return arguments.length && (D.currentView = e), D.currentView
            }, currentHistoryId: function () {
                return D.currentView ? D.currentView.historyId : null
            }, currentTitle: function (e) {
                return D.currentView ? (arguments.length && (D.currentView.title = e), D.currentView.title) : void 0
            }, backView: function (e) {
                return arguments.length && (D.backView = e), D.backView
            }, backTitle: function (e) {
                var t = e && c(e.backViewId) || D.backView;
                return t && t.title
            }, forwardView: function (e) {
                return arguments.length && (D.forwardView = e), D.forwardView
                ...
                if (e) {
                    var t = d(e);
                    if (t && t.stack.length) {
                        if (D.currentView && D.currentView.viewId === t.stack[0].viewId)return;
                        y = {viewId: t.stack[0].viewId, action: C, direction: B}, t.stack[0].go()
                    }
                }
            }, goBack: function () {
                D.backView && D.backView.go()
            }, enabledBack: function (e) {
                var t = s(e);
                return !(!t || t.historyId !== e.historyId)
            }, clearHistory: function () {
                var e = D.histories, t = D.currentView;
                ...
                for (var i in D.views)i !== t.viewId && delete D.views[i];
                t && p(t.viewId)
            }, clearCache: function () {
                a._instances.forEach(function (e) {
                    e.clearCache()
                })
            }, nextViewOptions: function (e) {
                return arguments.length && (o.cancel(b), null === e ? w = e : (w = w || {}, u(w, e), w.expire && (b = o(function () {
                    w = null
                }, w.expire)))), w
            }, isAbstractEle: function (e, t) {
                return t && t.$$state && t.$$state.self["abstract"] ? !0 : !(!e || !m(e) && !m(e.children()))
    ...
    }]).run(["$rootScope", "$state", "$location", "$document", "$ionicPlatform", "$ionicHistory", function (e, t, n, i, o, r) {
        function a(e) {
            var t = r.backView();
        ...
        }), e.$ionicGoBack = function () {
            r.goBack()
        }, e.$on("$ionicView.afterEnter", function (e, t) {
            t && t.title && (i[0].title = t.title)
        }), o.registerBackButtonAction(a, y)
    }]), l.provider("$ionicConfig", function () {
        function e(e, i) {
            a.platform[e] = i, o.platform[e] = {}, t(a, a.platform[e]), n(a.platform[e], o.platform[e], "")
        }

        function t(e, n) {
            for (var i in e)i != r && e.hasOwnProperty(i) && (angular.isObject(e[i]) ? (f(n[i]) || (n[i] = {}), t(e[i], n[i])) : f(n[i]) || (n[i] = null))
        }
        ...
        n(a, o, ""), e("default", {
        ...
        }), o.transitions = {views: {}, navBar: {}}, o.transitions.views.ios = function (e, t, n, i) {
            function o(e, t, n, i) {
                var o = {};
            ...
            function o(e, t, n, i) {
                var o = {};
                o[ionic.CSS.TRANSITION_DURATION] = c.shouldAnimate ? "" : 0, o.opacity = 1 === t ? "" : t, e.setCss("buttons-left", o), e.setCss("buttons-right", o), e.setCss("back-button", o), o[ionic.CSS.TRANSFORM] = "translate3d(" + i + "px,0,0)", e.setCss("back-text", o), o[ionic.CSS.TRANSFORM] = "translate3d(" + n + "px,0,0)", e.setCss("title", o)
            }

            function r(e, t, n) {
                if (e && t) {
                    var i = (e.titleTextX() + e.titleWidth()) * (1 - n), r = t && (t.titleTextX() - e.backButtonTextLeft()) * (1 - n) || 0;
                    o(e, n, i, r)
                }
            }
            ...
            function o(e, t) {
                var n = {};
                n[ionic.CSS.TRANSITION_DURATION] = r.shouldAnimate ? "" : 0, n[ionic.CSS.TRANSFORM] = "translate3d(" + t + "%,0,0)", ionic.DomUtil.cachedStyles(e, n)
            }
    ...
    var m = '<div class="loading-container"><div class="loading"></div></div>', $ = "$ionicLoading instance.hide() has been deprecated. Use $ionicLoading.hide().", w = "$ionicLoading instance.show() has been deprecated. Use $ionicLoading.show().", b = "$ionicLoading instance.setContent() has been deprecated. Use $ionicLoading.show({ template: 'my content' }).";
    l.constant("$ionicLoadingConfig", {template: "<ion-spinner></ion-spinner>"}).factory("$ionicLoading", ["$ionicLoadingConfig", "$ionicBody", "$ionicTemplateLoader", "$ionicBackdrop", "$timeout", "$q", "$log", "$compile", "$ionicPlatform", "$rootScope", function (e, t, n, i, o, r, a, c, l, d) {
        function f() {
            return v || (v = n.compile({template: m, appendTo: t.get()}).then(function (e) {
                return e.show = function (a) {
                    var s = a.templateUrl ? n.load(a.templateUrl) : r.when(a.template || a.content || "");
                    e.scope = a.scope || e.scope, e.isShown || (e.hasBackdrop = !a.noBackdrop && a.showBackdrop !== !1, e.hasBackdrop && (i.retain(), i.getElement().addClass("backdrop-loading"))), a.duration && (o.cancel(e.durationTimeout), e.durationTimeout = o(angular.bind(e, e.hide), +a.duration)), y(), y = l.registerBackButtonAction(g, B), s.then(function (n) {
                        if (n) {
                            var i = e.element.children();
                            i.html(n), c(i.contents())(e.scope)
                        }
                    ...
                    y(), e.isShown && (e.hasBackdrop && (i.release(), i.getElement().removeClass("backdrop-loading")), e.element.removeClass("active"), t.removeClass("loading-active"), setTimeout(function () {
                        !e.isShown && e.element.removeClass("visible")
                    }, 200)), o.cancel(e.durationTimeout), e.isShown = !1
                }, e
            })), v
        }
        ...
        function h(t) {
            ...
            return S(), k(), t.hideOnStateChange && (S = d.$on("$stateChangeSuccess", p), k = d.$on("$stateChangeError", p)), o.cancel(C), C = o(g, n), C.then(f).then(function (e) {
                return e.show(t)
            }), {
                hide: s.method($, a.error, p), show: s.method(w, a.error, function () {
                    h(t)
                }), setContent: s.method(b, a.error, function (e) {
                    f().then(function (t) {
                        t.show({template: e})
                    })
                })
        ...
        function p() {
            S(), k(), o.cancel(C), f().then(function (e) {
                e.hide()
            })
        }

        var v, y = g, S = g, k = g, C = r.when();
        return {show: h, hide: p, _getLoader: f}
    }]), l.factory("$ionicModal", ["$rootScope", "$ionicBody", "$compile", "$timeout", "$ionicPlatform", "$ionicTemplateLoader", "$q", "$log", function (e, t, n, i, o, r, a, c) {
        var s = ionic.views.Modal.inherit({
            initialize: function (e) {
                ionic.views.Modal.prototype.initialize.call(this, e), this.animation = e.animation || "slide-in-up"
            }, show: function (e) {
                var n = this;
                if (n.scope.$$destroyed)return void c.error("Cannot call " + n.viewType + ".show() after remove(). Please create a new " + n.viewType + " instance.");
                var r = v(n.modalEl);
                return n.el.classList.remove("hide"), i(function () {
                    t.addClass(n.viewType + "-open")
                }, 400), n.el.parentElement || (r.addClass(n.animation), t.append(n.el)), e && n.positionView && (n.positionView(e, r), ionic.on("resize", function () {
                    ionic.off("resize", null, window), n.positionView(e, r)
                }, window)), r.addClass("ng-enter active").removeClass("ng-leave ng-leave-active"), n._isShown = !0, n._deregisterBackButton = o.registerBackButtonAction(n.hardwareBackButtonClose ? angular.bind(n, n.hide) : g, k), ionic.views.Modal.prototype.show.call(n), i(function () {
                    r.addClass("ng-enter-active"), ionic.trigger("resize"), n.scope.$parent && n.scope.$parent.$broadcast(n.viewType + ".shown", n), n.el.classList.add("active"), n.scope.$broadcast("$ionicHeader.align")
                }, 20), i(function () {
                    n.$el.on("click", function (e) {
                        n.backdropClickToClose && e.target === n.el && n.hide()
                    })
                }, 400)
            }, hide: function () {
                var e = this, n = v(e.modalEl);
                return e.el.classList.remove("active"), n.addClass("ng-leave"), i(function () {
                    n.addClass("ng-leave-active").removeClass("ng-enter ng-enter-active active")
                }, 20), e.$el.off("click"), e._isShown = !1, e.scope.$parent && e.scope.$parent.$broadcast(e.viewType + ".hidden", e), e._deregisterBackButton && e._deregisterBackButton(), ionic.views.Modal.prototype.hide.call(e), e.positionView && ionic.off("resize", null, window), i(function () {
            ...
            i.viewType = i.viewType || "modal", u(o, {
                $hasHeader: !1,
                $hasSubheader: !1,
                $hasFooter: !1,
                $hasSubfooter: !1,
    ...
    }]), l.service("$ionicNavBarDelegate", ionic.DelegateService(["align", "showBackButton", "showBar", "title", "changeTitle", "setTitle", "getTitle", "back", "getPreviousTitle"])), l.service("$ionicNavViewDelegate", ionic.DelegateService(["clearCache"]));
    var y = 100, S = 150, k = 200, C = 300, T = 400, B = 500;
    l.provider("$ionicPlatform", function () {
        return {
            $get: ["$q", "$rootScope", function (e) {
                var t = {
                    onHardwareBackButton: function (e) {
                        ...
                        var o = {id: i ? i : ionic.Utils.nextUid(), priority: n ? n : 0, fn: e};
                        return t.$backButtonActions[o.id] = o, function () {
    ...
    }), l.factory("$ionicPopover", ["$ionicModal", "$ionicPosition", "$document", "$window", function (e, t, n, i) {
        function o(e, o) {
            var a = v(e.target || e), c = t.offset(a), s = o.prop("offsetWidth"), l = o.prop("offsetHeight"), u = n[0].body.clientWidth, d = i.innerHeight, f = {left: c.left + c.width / 2 - s / 2}, h = v(o[0].querySelector(".popover-arrow"));
            f.left < r ? f.left = r : f.left + s + r > u && (f.left = u - s - r), c.top + c.height + l > d && c.top - l > 0 ? (f.top = c.top - l, o.addClass("popover-bottom")) : (f.top = c.top + c.height, o.removeClass("popover-bottom")), h.css({left: c.left + c.width / 2 - h.prop("offsetWidth") / 2 - f.left + "px"}), o.css({
                top: f.top + "px",
                left: f.left + "px",
                marginLeft: "0",
                opacity: "1"
    ...
    var I = '<div class="popup-container" ng-class="cssClass"><div class="popup"><div class="popup-head"><h3 class="popup-title" ng-bind-html="title"></h3><h5 class="popup-sub-title" ng-bind-html="subTitle" ng-if="subTitle"></h5></div><div class="popup-body"></div><div class="popup-buttons" ng-show="buttons.length"><button ng-repeat="button in buttons" ng-click="$buttonTapped(button, $event)" class="button" ng-class="button.type || \'button-default\'" ng-bind-html="button.text"></button></div></div></div>';
    l.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", function (e, t, n, i, o, r, a, c) {
        function s(t) {
            t = u({scope: null, title: "", buttons: []}, t || {});
            var o = e.compile({
                template: I,
                scope: t.scope && t.scope.$new(),
                appendTo: r.get()
            }), c = t.templateUrl ? e.load(t.templateUrl) : n.when(t.template || t.content || "");
            return n.all([o, c]).then(function (e) {
                var o = e[0], r = e[1], c = n.defer();
                o.responseDeferred = c;
                var s = v(o.element[0].querySelector(".popup-body"));
                return r ? (s.html(r), a(s.contents())(o.scope)) : s.remove(), u(o.scope, {
                    title: t.title,
                    buttons: t.buttons,
                    subTitle: t.subTitle,
                    cssClass: t.cssClass,
                    $buttonTapped: function (e, t) {
                        var n = (e.onTap || g)(t);
                        t = t.originalEvent || t, t.defaultPrevented || c.resolve(n)
                    }
                }), o.show = function () {
                    o.isShown || (o.isShown = !0, ionic.requestAnimationFrame(function () {
                        o.isShown && (o.element.removeClass("popup-hidden"), o.element.addClass("popup-showing active"), f(o.element))
                    }))
                }, o.hide = function (e) {
                    return e = e || g, o.isShown ? (o.isShown = !1, o.element.removeClass("active"), o.element.addClass("popup-hidden"), void i(e, 250)) : e()
                }, o.remove = function () {
                    o.removed || (o.hide(function () {
                        o.element.remove(), o.scope.$destroy()
                    }), o.removed = !0)
                }, o
            })
        }
        ...
        function l() {
            w[0] && w[0].responseDeferred.resolve()
        }

        function d(e) {
            function n(e) {
                o.then(function (t) {
                    t.removed || t.responseDeferred.resolve(e)
                })
            }

            var o = b._createPopup(e), a = w[0];
            a && a.hide();
            var s = i(g, a ? $.stackPushDelay : 0).then(function () {
                return o
            }).then(function (e) {
                return a || (r.addClass("popup-open"), t.retain(), b._backButtonActionDone = c.registerBackButtonAction(l, T)), w.unshift(e), e.show(), e.responseDeferred.notify({close: s.close}), e.responseDeferred.promise.then(function (n) {
                    var o = w.indexOf(e);
                    -1 !== o && w.splice(o, 1), e.remove();
                    var a = w[0];
                    return a ? a.show() : (i(function () {
                        r.removeClass("popup-open")
                    }, 400), i(function () {
                        t.release()
                    }, $.stackPushDelay || 0), (b._backButtonActionDone || g)()), n
                })
            });
            return s.close = n, s
        }
        ...
        function m(e) {
            ...
            t.data = {};
            var n = "";
            return e.template && /<[a-z][\s\S]*>/i.test(e.template) === !1 && (n = "<span>" + e.template + "</span>", delete e.template), d(u({
        ...
        return b
    }]), l.factory("$ionicPosition", ["$document", "$window", function (e, t) {
        function n(e, n) {
        ...
        return {
            position: function (t) {
                ...
                r != e[0] && (i = this.offset(v(r)), i.top += r.clientTop - r.scrollTop, i.left += r.clientLeft - r.scrollLeft);
    ...
    }]), l.service("$ionicScrollDelegate", ionic.DelegateService(["resize", "scrollTop", "scrollBottom", "scrollTo", "scrollBy", "zoomTo", "zoomBy", "getScrollPosition", "anchorScroll", "freezeScroll", "freezeAllScrolls", "getScrollView"])), l.service("$ionicSideMenuDelegate", ionic.DelegateService(["toggleLeft", "toggleRight", "getOpenRatio", "isOpen", "isOpenLeft", "isOpenRight", "canDragContent", "edgeDragThreshold"])), l.service("$ionicSlideBoxDelegate", ionic.DelegateService(["update", "slide", "select", "enableSlide", "previous", "next", "stop", "autoPlay", "start", "currentIndex", "selected", "slidesCount", "count", "loop"])), l.service("$ionicTabsDelegate", ionic.DelegateService(["select", "selectedIndex"])), function () {
        var e = [];
        l.factory("$ionicTemplateCache", ["$http", "$templateCache", "$timeout", function (t, n, i) {
            function o(e) {
                return "undefined" == typeof e ? r() : (p(e) && (e = [e]), d(e, function (e) {
                    c.push(e)
                }), void(a && r()))
            }
            ...
            function r() {
                if (o._runCount++, a = !0, 0 !== c.length) {
                    for (var e = 0; 4 > e && (template = c.pop());)p(template) && t.get(template, {cache: n}), e++;
                    c.length && i(r, 1e3)
                }
            }
            ...
            t.state = function (o, r) {
                if ("object" == typeof r) {
                    ...
                    if (a && p(r.templateUrl) && e.push(r.templateUrl), angular.isObject(r.views))for (var c in r.views)a = r.views[c].prefetchTemplate !== !1 && e.length < n.templates.maxPrefetch(), a && p(r.views[c].templateUrl) && e.push(r.views[c].templateUrl)
                }
                return i.call(t, o, r)
            }
    ...
    }(), l.factory("$ionicTemplateLoader", ["$compile", "$controller", "$http", "$q", "$rootScope", "$templateCache", function (e, t, n, i, o, r) {
        function a(e) {
        ...
        function c(n) {
            n = u({template: "", templateUrl: "", scope: null, controller: null, locals: {}, appendTo: null}, n || {});
            var r = n.templateUrl ? this.load(n.templateUrl) : i.when(n.template);
            return r.then(function (i) {
                var r, a = n.scope || o.$new(), c = v("<div>").html(i).contents();
                return n.controller && (r = t(n.controller, u(n.locals, {$scope: a})), c.children().data("$ngControllerController", r)), n.appendTo && v(n.appendTo).append(c), e(c)(a), {
                    element: c,
                    scope: a
                }
            })
        ...
        return {load: a, compile: c}
    }]), l.factory("$ionicViewService", ["$ionicHistory", "$log", function (e, t) {
        function n(e, n) {
        ...
        return d(i, function (t, o) {
            i[o] = function () {
                return n("." + o, "." + t), e[t].apply(this, arguments)
            }
        }), i
    }]), l.factory("$ionicViewSwitcher", ["$timeout", "$document", "$q", "$ionicClickBlock", "$ionicConfig", "$ionicNavBarDelegate", function (e, t, n, i, o, r) {
        function a(e, t) {
        ...
        function s(e, t, n, i) {
            var r = c(e), a = g || V(t, "view-transition") || r.viewTransition || o.views.transition() || "ios", s = o.navBar.transition();
            return n = m || V(t, "view-direction") || r.viewDirection || n || "none", u(l(i), {
                transition: a,
        ...
        function p(e) {
            if (e && e.length) {
                var t = e.scope();
                t && (t.$emit("$ionicView.unloaded", e.data(C)), t.$destroy()), e.remove()
            }
        }

        var g, m, $ = "webkitTransitionEnd transitionend", w = "$noCache", b = "$destroyEle", y = "$eleId", S = "$accessed", k = "$fallbackTimer", C = "$viewData", T = "nav-view", B = "active", I = "cached", x = "stage", A = 0;
        ionic.transition = ionic.transition || {}, ionic.transition.isActive = !1;
        var E, V = ionic.DomUtil.cachedAttr, P = [], D = 1100, L = {
            create: function (t, d, v, T, E, _) {
                var R, M, N, H = ++A, z = {
                    init: function (e, t) {
                        L.isTransitioning(!0), z.loadViewElements(e), z.render(e, function () {
                            t && t()
                        })
                    }, loadViewElements: function (e) {
                        var n, i, o, r = t.getViewElements(), c = a(d, v), s = t.activeEleId();
                        for (n = 0, i = r.length; i > n && (o = r.eq(n), o.data(y) === c ? o.data(w) ? (o.data(y, c + ionic.Utils.nextUid()), o.data(b, !0)) : R = o : f(s) && o.data(y) === s && (M = o), !R || !M); n++);
                        N = !!R, N || (R = e.ele || L.createViewEle(d), R.data(y, c)), _ && t.activeEleId(c), e.ele = null
                    }, render: function (e, n) {
                        if (N)ionic.Utils.reconnectScope(R.scope()); else {
                            h(R, x);
                            var i = s(d, R, e.direction, v), r = o.transitions.views[i.transition] || o.transitions.views.none;
                            r(R, null, i.direction, !0).run(0), R.data(C, {
                                viewId: i.viewId,
                                historyId: i.historyId,
                                stateName: i.stateName,
                                stateParams: i.stateParams
                            }), (c(d).cache === !1 || "false" === c(d).cache || "false" == R.attr("cache-view") || 0 === o.views.maxCache()) && R.data(w, !0);
                            var a = t.appendViewElement(R, d);
                            delete i.direction, delete i.transition, a.$emit("$ionicView.loaded", i)
                        }
                        R.data(S, Date.now()), n && n()
                    }, transition: function (a, c, f) {
                        function p() {
                            h(R, F.shouldAnimate ? "entering" : B), h(M, F.shouldAnimate ? "leaving" : I), F.run(1), r._instances.forEach(function (e) {
                        ...
                        function b() {
                            b.x || (b.x = !0, R.off($, w), e.cancel(R.data(k)), M && e.cancel(M.data(k)), z.emit("after", O, U), C && C.resolve(t), H === A && (n.all(P).then(L.transitionEnd), z.cleanup(O)), r._instances.forEach(function (e) {
                        ...
                        function S() {
                            h(R, I), h(M, B), R.off($, y), e.cancel(R.data(k)), L.transitionEnd([t])
                        }

                        var C, O = s(d, R, a, v), U = u(u({}, O), l(T));
                        O.transitionId = U.transitionId = H, O.fromCache = !!N, O.enableBack = !!c, O.renderStart = E, O.renderEnd = _, V(R.parent(), "nav-view-transition", O.transition), V(R.parent(), "nav-view-direction", O.direction), e.cancel(R.data(k));
                        var q = o.transitions.views[O.transition] || o.transitions.views.none, F = q(R, M, O.direction, O.shouldAnimate && f && _);
                        if (F.shouldAnimate && (R.on($, w), R.data(k, e(b, D)), i.show(D)), E && (z.emit("before", O, U), h(R, x), F.run(0)), _ && (C = n.defer(), P.push(C.promise)), E && _)e(p, 16); else {
                            if (!_)return h(R, "entering"), h(M, "leaving"), {
                                run: F.run, cancel: function (t) {
                                    t ? (R.on($, y), R.data(k, e(S, D)), i.show(D)) : S(), F.shouldAnimate = t, F.run(0), F = null
                                }
                            };
                            _ && p()
                        }
                        ...
                        var i = R.scope();
                        i && (i.$emit("$ionicView." + e + "Enter", t), "after" == e && i.$emit("$ionicView.enter", t)), M ? (i = M.scope(), i && (i.$emit("$ionicView." + e + "Leave", n), "after" == e && i.$emit("$ionicView.leave", n))) : i && n && n.viewId && (i.$emit("$ionicNavView." + e + "Leave", n), "after" == e && i.$emit("$ionicNavView.leave", n))
                    }, cleanup: function (e) {
                        M && "back" == e.direction && !o.views.forwardCache() && p(M);
                        var n, i, r, a = t.getViewElements(), c = a.length, s = c - 1 > o.views.maxCache(), l = Date.now();
                        for (n = 0; c > n; n++)i = a.eq(n), s && i.data(S) < l ? (l = i.data(S), r = a.eq(n)) : i.data(b) && h(i) != B && p(i);
                        p(r), R.data(w) && R.data(b, !0)
                ...
                return e && e.$template && (n.innerHTML = e.$template, 1 === n.children.length) ? (n.children[0].classList.add("pane"), v(n.children[0])) : (n.className = "pane", v(n))
            }, viewEleIsActive: function (e, t) {
                h(e, t ? B : I)
            }, getTransitionData: s, navViewAttr: h, destroyViewEle: p
        };
        return L
    }]), l.config(["$provide", function (e) {
    ...
    }]), l.controller("$ionicHeaderBar", ["$scope", "$element", "$attrs", "$q", "$ionicConfig", "$ionicHistory", function (e, t, n, i, o, r) {
        function a(e) {
            return C[e] || (C[e] = t[0].querySelector("." + e)), C[e]
        }

        var c = "title", s = "back-text", l = "back-button", u = "default-title", d = "previous-title", f = "hide", h = this, p = "", v = "", g = 0, m = 0, $ = "", w = !1, b = !0, y = !0, S = !1, k = 0;
        h.beforeEnter = function (t) {
            ...
            var i, o, r, h, p, v, g, m, $, w = a(c), y = a(l), S = t[0].childNodes, k = 0, C = 0, T = 0, B = 0, I = "", x = 0;
            ...
            if ("left" == e)I = "title-left", k && (T = k + 15), C && (B = C + 15); else if ("right" == e)I = "title-right", k && (T = k + 15), C && (B = C + 15); else {
    ...
    }]), l.controller("$ionInfiniteScroll", ["$scope", "$attrs", "$element", "$timeout", function (e, t, n, i) {
        function o() {
            ionic.requestAnimationFrame(function () {
        ...
        function r() {
            ionic.requestAnimationFrame(function () {
                ...
                s.jsScrolling && s.scrollView.resize(), s.checkBounds()
            }, 30, !1), s.isLoading = !1
        }
        ...
        function c(e) {
            return distance = (t.distance || "2.5%").trim(), isPercent = -1 !== distance.indexOf("%"), isPercent ? e * (1 - parseFloat(distance) / 100) : e - parseFloat(distance)
        }

        var s = this;
        s.isLoading = !1, e.icon = function () {
            return f(t.icon) ? t.icon : "ion-load-d"
        }, e.spinner = function () {
            return f(t.spinner) ? t.spinner : ""
    ...
    }]), l.service("$ionicListDelegate", ionic.DelegateService(["showReorder", "showDelete", "canSwipeItems", "closeOptionButtons"])).controller("$ionicList", ["$scope", "$attrs", "$ionicListDelegate", "$ionicHistory", function (e, t, n, i) {
    ...
    }]), l.controller("$ionicNavBar", ["$scope", "$element", "$attrs", "$compile", "$timeout", "$ionicNavBarDelegate", "$ionicConfig", "$ionicHistory", function (e, t, n, i, o, r, a, c) {
        function s(e, t) {
        ...
        var m, $, w, b = "hide", y = "$ionNavBarController", S = "primaryButtons", k = "secondaryButtons", C = "backButton", T = "primaryButtons secondaryButtons leftButtons rightButtons title".split(" "), B = this, I = [], x = {}, A = !0;
        t.parent().data(y, B);
        var E = n.delegateHandle || "navBar" + ionic.Utils.nextUid(), V = r._registerInstance(B, E);
        B.init = function () {
            t.addClass("nav-bar-container"), ionic.DomUtil.cachedAttr(t, "nav-bar-transition", a.views.transition()), B.createHeaderBar(!1), B.createHeaderBar(!0), e.$emit("ionNavBar.init", E)
        }, B.createHeaderBar = function (o) {
            function r(e, t) {
                e && ("title" === t ? g.append(e) : "rightButtons" == t || t == k && "left" != a.navBar.positionSecondaryButtons() || t == S && "right" == a.navBar.positionPrimaryButtons() ? (p || (p = v('<div class="buttons buttons-right">'), u.append(p)), t == k ? p.append(e) : p.prepend(e)) : (h || (h = v('<div class="buttons buttons-left">'), m[C] ? m[C].after(h) : u.prepend(h)), t == k ? h.append(e) : h.prepend(e)))
            }

            var c = v('<div class="nav-bar-block">');
            ionic.DomUtil.cachedAttr(c, "nav-bar", o ? "active" : "cached");
            var s = n.alignTitle || a.navBar.alignTitle(), u = v("<ion-header-bar>").addClass(n["class"]).attr("align-title", s);
            f(n.noTapScroll) && u.attr("no-tap-scroll", n.noTapScroll);
            var h, p, g = v('<div class="title title-' + s + '">'), m = {}, $ = {};
            m[C] = l(C), m[C] && u.append(m[C]), u.append(g), d(T, function (e) {
                m[e] = l(e), r(m[e], e)
            });
            for (var w = 0; w < u[0].children.length; w++)u[0].children[w].classList.add("header-item");
            c.append(u), t.append(i(c)(e.$new()));
            var y = u.data("$ionHeaderBarController"), B = {
                isActive: o, title: function (e) {
                    y.title(e)
                }, setItem: function (e, t) {
                    B.removeItem(t), e ? ("title" === t && B.title(""), r(e, t), m[t] && m[t].addClass(b), $[t] = e) : m[t] && m[t].removeClass(b)
                    ...
                    h && h.removeData(), p && p.removeData(), g.removeData(), u.removeData(), c.remove(), c = u = g = h = p = null
                }
            };
            return I.push(B), B
        }, B.navElement = function (e, t) {
            return f(t) && (x[e] = t), x[e]
        }, B.update = function (e) {
            var t = !e.hasHeaderBar && e.showNavBar;
            e.transition = a.views.transition(), t || (e.direction = "none"), B.enable(t);
            var n = B.isInitialized ? h() : u(), i = B.isInitialized ? u() : null, o = n.controller();
            o.enableBack(e.enableBack, !0), o.showBack(e.showBack, !0), o.updateBackButton(), B.title(e.title, n), B.showBar(t), e.navBarItems && d(T, function (t) {
                n.setItem(e.navBarItems[t], t)
            }), B.transition(n, i, e), B.isInitialized = !0, g("")
        }, B.transition = function (e, n, i) {
            function r() {
                for (var t = 0; t < I.length; t++)I[t].isActive = !1;
                e.isActive = !0, p(e, "active"), p(n, "cached"), B.activeTransition = u = $ = null
            }

            var c = e.controller(), s = a.transitions.navBar[i.navBarTransition] || a.transitions.navBar.none, l = i.transitionId;
            c.beforeEnter(i);
            var u = s(e, n, i.direction, i.shouldAnimate && B.isInitialized);
            ionic.DomUtil.cachedAttr(t, "nav-bar-transition", i.navBarTransition), ionic.DomUtil.cachedAttr(t, "nav-bar-direction", i.direction), u.shouldAnimate && i.renderEnd ? p(e, "stage") : (p(e, "entering"), p(n, "leaving")), c.resetBackButton(i), u.run(0), B.activeTransition = {
                run: function (e) {
                    u.shouldAnimate = !1, u.direction = "back", u.run(e)
                }, cancel: function (t, i) {
                    g(i), p(n, "active"), p(e, "cached"), u.shouldAnimate = t, u.run(0), B.activeTransition = u = null
                }, complete: function (e, t) {
                    g(t), u.shouldAnimate = e, u.run(1), $ = r
                }
            }, o(c.align, 16), (m = function () {
                w === l && (p(e, "entering"), p(n, "leaving"), u.run(1), $ = function () {
                    w != l && u.shouldAnimate || r()
                }, m = null)
            })()
            ...
            return arguments.length && (B.visibleBar(t), e.$parent.$hasHeader = !!t), !!e.$parent.$hasHeader
        }, B.visibleBar = function (e) {
            e && !A ? t.removeClass(b) : !e && A && t.addClass(b), A = e
        }, B.enable = function (e) {
            B.visibleBar(e);
            ...
            return e.$isBackButtonShown = !!t, e.$isBackButtonShown
        }, B.showActiveBackButton = function (e) {
            var t = u();
            t && t.controller().showBack(e)
        }, B.title = function (t, n) {
            return f(t) && (t = t || "", n = n || u(), n && n.title(t), e.$title = t, c.currentTitle(t)), e.$title
        }, B.align = function (e, t) {
            t = t || u(), t && t.controller().align(e)
            ...
            s("changeTitle(val)", "title(val)"), B.title(e)
        }, B.setTitle = function (e) {
            s("setTitle(val)", "title(val)"), B.title(e)
        }, B.getTitle = function () {
            return s("getTitle()", "title()"), B.title()
        }, B.back = function () {
            s("back()", "$ionicHistory.goBack()"), c.goBack()
        }, B.getPreviousTitle = function () {
            s("getPreviousTitle()", "$ionicHistory.backTitle()"), c.goBack()
        }, e.$on("$destroy", function () {
            e.$parent.$hasHeader = !1, t.parent().removeData(y);
            for (var n = 0; n < I.length; n++)I[n].destroy();
            t.remove(), t = I = null, V()
        })
    }]), l.controller("$ionicNavView", ["$scope", "$element", "$attrs", "$compile", "$controller", "$ionicNavBarDelegate", "$ionicNavViewDelegate", "$ionicHistory", "$ionicViewSwitcher", "$ionicConfig", "$ionicScrollDelegate", function (e, t, n, i, o, r, a, c, s, l, d) {
        function f(e, n) {
            for (var i, o, r = t.children(), a = 0, c = r.length; c > a; a++)if (i = r.eq(a), A(i) == T) {
                o = i.scope(), o && o.$emit(e.name.replace("Tabs", "View"), n);
                break
            }
        }
        ...
        var m, $, w, b, y, S = "$eleId", k = "$destroyEle", C = "$noCache", T = "active", B = "cached", I = this, x = !1, A = s.navViewAttr;
        I.scope = e, I.element = t, I.init = function () {
            ...
            return e.$on("$destroy", function () {
                s(), I.isSwipeFreeze && d.freezeAllScrolls(!1)
            }), e.$on("$ionicHistory.deselect", I.cacheCleanup), e.$on("$ionicTabs.top", p), e.$on("$ionicSubheader", v), e.$on("$ionicTabs.beforeLeave", f), e.$on("$ionicTabs.afterLeave", f), e.$on("$ionicTabs.leave", f), ionic.Platform.ready(function () {
                ionic.Platform.isWebView() && l.views.swipeBackEnabled() && I.initSwipeBack()
            }), c
        }, I.register = function (t) {
            var n = u({}, c.currentView()), i = c.register(e, t);
            I.update(i);
            var o = c.getViewById(i.viewId) || {}, r = b !== i.viewId;
            ...
            var a = s.create(I, t, n, i, o, r);
            a.init(e, function () {
                a.transition(I.direction(), e.enableBack, !y), b = y = null
            })
            ...
            for (e = 0, n = o.length; n > e; e++)i = o.eq(e), i.data(S) === w ? A(i, T) : ("leaving" === A(i) || A(i) === T || A(i) === B) && (i.data(k) || i.data(C) ? s.destroyViewEle(i) : (A(i, B), ionic.Utils.disconnectScope(i.scope())));
            h(""), I.isSwipeFreeze && d.freezeAllScrolls(!1)
        }, I.cacheCleanup = function () {
            for (var e = t.children(), n = 0, i = e.length; i > n; n++)e.eq(n).data(k) && s.destroyViewEle(e.eq(n))
        }, I.clearCache = function () {
            for (var e, n, i = t.children(), o = 0, r = i.length; r > o; o++)e = i.eq(o), A(e) == B ? s.destroyViewEle(e) : A(e) == T && (n = e.scope(), n && n.$broadcast("$ionicView.clearCache"))
            ...
            function n(e) {
                if (x && (S = r(e), !(S > C) && (p = c.backView(), p && p.historyId === c.currentView().historyId))) {
                    w || (w = window.innerWidth), I.isSwipeFreeze = d.freezeAllScrolls(!0);
                    var n = {direction: "back"};
                    k = [];
                    var a = s.create(I, n, p, c.currentView(), !0, !1);
                    a.loadViewElements(n), a.render(n), u = a.transition("back", c.enabledBack(p), !0), f = g(), m = ionic.onGesture("drag", i, t[0]), $ = ionic.onGesture("release", o, t[0])
                }
            }
            ...
            function i(e) {
                if (x && u) {
                    var t = r(e);
                    if (k.push({t: Date.now(), x: t}), t >= w - 15)o(e); else {
                        var n = Math.min(Math.max(a(t), 0), 1);
                        u.run(n), f && f.activeTransition && f.activeTransition.run(n)
                    }
                }
            }
            ...
            function o(e) {
                if (x && u && k && k.length > 1) {
                    for (var t = Date.now(), n = r(e), c = k[k.length - 1], s = k.length - 2; s >= 0 && !(t - c.t > 200); s--)c = k[s];
                    var l = n >= k[k.length - 2].x, v = a(n), g = Math.abs(c.x - n) / (t - c.t);
                    if (b = p.viewId, y = .03 > v || v > .97, l && (v > .5 || g > .1)) {
                        var S = g > .5 || .05 > g || n > w - 45 ? "fast" : "slow";
                        h(y ? "" : S), p.go(), f && f.activeTransition && f.activeTransition.complete(!y, S)
                    } else h(y ? "" : "fast"), b = null, u.cancel(!y), f && f.activeTransition && f.activeTransition.cancel(!y, "fast"), y = null
                }
                ionic.offGesture(m, "drag", i), ionic.offGesture($, "release", o), w = u = k = null, I.isSwipeFreeze = d.freezeAllScrolls(!1)
            }
            ...
            var u, f, p, v, m, $, w, S, k, C = l.views.swipeBackHitWidth();
            v = ionic.onGesture("dragstart", n, t[0]), e.$on("$destroy", function () {
                ionic.offGesture(v, "dragstart", n), ionic.offGesture(m, "drag", i), ionic.offGesture($, "release", o), I.element = u = f = null
            })
        }
    }]), l.controller("$ionicRefresher", ["$scope", "$attrs", "$element", "$ionicBind", "$timeout", function (e, t, n, i, o) {
        function r() {
            return P || k ? (E = null, k ? (k = !1, T = 0, B > I ? (g(), d(I, A)) : (d(0, A, v), C = !1), !0) : (T = 0, C = !1, u(!1), !0)) : void 0
        }

        function a(e) {
            if (P && !(e.touches.length > 1)) {
                if (null === E && (E = parseInt(e.touches[0].screenY, 10)), V = parseInt(e.touches[0].screenY, 10) - E, 0 >= V - T || 0 !== b.scrollTop)return C && (C = !1, u(!1)), k && l(b, -1 * parseInt(V - T, 10)), 0 !== B && s(0), !0;
                V > 0 && 0 === b.scrollTop && !C && (T = V), e.preventDefault(), C || (C = !0, u(!0)), k = !0, s(parseInt((V - T) / 3, 10)), !x && B > I ? (x = !0, ionic.requestAnimationFrame(p)) : x && I > B && (x = !1, ionic.requestAnimationFrame(v))
            }
        }
        ...
        function s(e) {
            y.style[ionic.CSS.TRANSFORM] = "translateY(" + e + "px)", B = e
        }
        ...
        function u(e) {
            ionic.requestAnimationFrame(e ? function () {
                y.classList.add("overscroll"), m()
            } : function () {
                y.classList.remove("overscroll"), $(), v()
            })
        }
        ...
        function d(e, t, n) {
            ...
            function o() {
                var c = Date.now(), l = Math.min(1, (c - r) / t), d = i(l);
                s(parseInt(d * (e - a) + a, 10)), 1 > l ? ionic.requestAnimationFrame(o) : (5 > e && e > -5 && (C = !1, u(!1)), n && n())
            }
        ...
        function h() {
            ionic.off("touchmove", a, y), ionic.off("touchend", r, y), ionic.off("scroll", c, b), b = null, y = null
        }
        ...
        function v() {
            o(function () {
                n.removeClass("active refreshing refreshing-tail"), x && (x = !1)
            }, 150)
        }
        ...
        var b, y, S = this, k = !1, C = !1, T = 0, B = 0, I = 60, x = !1, A = 500, E = null, V = null, P = !0;
        f(t.pullingIcon) || t.$set("pullingIcon", "ion-android-arrow-down"), e.showSpinner = !f(t.refreshingIcon) && "none" != t.spinner, e.showIcon = f(t.refreshingIcon), i(e, t, {
            pullingIcon: "@",
            pullingText: "@",
            refreshingIcon: "@",
            refreshingText: "@",
            ...
            o(function () {
                ionic.requestAnimationFrame(w), d(0, A, v), o(function () {
                    C && (C = !1, u(!1))
                }, A)
            }, A)
        }), S.init = function () {
            if (b = n.parent().parent()[0], y = n.parent()[0], !b.classList.contains("ionic-scroll") || !y.classList.contains("scroll"))throw new Error("Refresher must be immediate child of ion-content or ion-scroll");
            ionic.on("touchmove", a, y), ionic.on("touchend", r, y), ionic.on("scroll", c, b), e.$on("$destroy", h)
        }, S.getRefresherDomMethods = function () {
            return {activate: p, deactivate: v, start: g, show: m, hide: $, tail: w}
        }, S.__handleTouchmove = a, S.__getScrollChild = function () {
            return y
        }, S.__getScrollParent = function () {
            return b
        }
    }]), l.controller("$ionicScroll", ["$scope", "scrollViewOptions", "$timeout", "$window", "$location", "$document", "$ionicScrollDelegate", "$ionicHistory", function (e, t, n, i, o, r, a, c) {
        var s = this;
        s.__timeout = n, s._scrollViewOptions = t;
        var l = s.element = t.el, u = s.$element = v(l), d = s.scrollView = new ionic.views.Scroll(t);
        (u.parent().length ? u.parent() : u).data("$$ionicScrollController", s);
        var h = a._registerInstance(s, t.delegateHandle, function () {
            return c.isActiveScope(e)
        });
        f(t.bouncing) || ionic.Platform.ready(function () {
            d.options && (d.options.bouncing = !0, ionic.Platform.isAndroid() && (d.options.bouncing = !1, d.options.deceleration = .95))
        });
        var p = angular.bind(d, d.resize);
        angular.element(i).on("resize", p);
        var g = function (t) {
            var n = (t.originalEvent || t).detail || {};
            e.$onScroll && e.$onScroll({event: t, scrollTop: n.scrollTop || 0, scrollLeft: n.scrollLeft || 0})
        };
        u.on("scroll", g), e.$on("$destroy", function () {
            h(), d && d.__cleanup && d.__cleanup(), angular.element(i).off("resize", p), u.off("scroll", g), d = s.scrollView = t = s._scrollViewOptions = t.el = s._scrollViewOptions.el = u = s.$element = l = null
        }), n(function () {
            d && d.run && d.run()
            ...
            return n(p).then(function () {
                u && u.triggerHandler("scroll.resize")
            })
            ...
            s.resize().then(function () {
                var t = d.getScrollMax();
                d.scrollTo(t.left, t.top, !!e)
            })
            ...
            s.resize().then(function () {
                ...
                if (!t || !n)return void d.scrollTo(0, 0, !!e);
                var i = n, a = 0, c = 0, l = 0;
                do null !== i && (a += i.offsetLeft), null !== i && (c += i.offsetTop), i = i.offsetParent, l++; while (i.attributes != s.element.attributes && i.offsetParent);
                d.scrollTo(a, c, !!e)
            })
        }, s.freezeScroll = d.freeze, s.freezeAllScrolls = function (e) {
            ...
            d.activatePullToRefresh(i, n)
        }
    }]), l.controller("$ionicSideMenus", ["$scope", "$attrs", "$ionicSideMenuDelegate", "$ionicPlatform", "$ionicBody", "$ionicHistory", "$ionicScrollDelegate", function (e, t, n, i, o, r, a) {
        function c(e) {
            e && !m.isScrollFreeze ? a.freezeAllScrolls(e) : !e && m.isScrollFreeze && a.freezeAllScrolls(!1), m.isScrollFreeze = e
        }

        var s, l, u, d, f, p, v, m = this, $ = !0;
        m.$scope = e, m.initialize = function (e) {
            m.left = e.left, m.right = e.right, m.setContent(e.content), m.dragThresholdX = e.dragThresholdX || 10, r.registerHistory(m.$scope)
        }, m.setContent = function (e) {
            e && (m.content = e, m.content.onDrag = function (e) {
                m._handleDrag(e)
            }, m.content.endDrag = function (e) {
                m._endDrag(e)
            })
        }, m.isOpenLeft = function () {
            return m.getOpenAmount() > 0
        }, m.isOpenRight = function () {
            return m.getOpenAmount() < 0
        }, m.toggleLeft = function (e) {
            if (!v && m.left.isEnabled) {
                var t = m.getOpenAmount();
                0 === arguments.length && (e = 0 >= t), m.content.enableAnimation(), m.openPercentage(e ? 100 : 0)
            }
        }, m.toggleRight = function (e) {
            if (!v && m.right.isEnabled) {
                var t = m.getOpenAmount();
                0 === arguments.length && (e = t >= 0), m.content.enableAnimation(), m.openPercentage(e ? -100 : 0)
            }
        }, m.toggle = function (e) {
            "right" == e ? m.toggleRight() : m.toggleLeft()
        }, m.close = function () {
            m.openPercentage(0)
        }, m.getOpenAmount = function () {
            return m.content && m.content.getTranslateX() || 0
        }, m.getOpenRatio = function () {
            var e = m.getOpenAmount();
            return e >= 0 ? e / m.left.width : e / m.right.width
        }, m.isOpen = function () {
            return 0 !== m.getOpenAmount()
        }, m.getOpenPercentage = function () {
            return 100 * m.getOpenRatio()
        }, m.openPercentage = function (e) {
            var t = e / 100;
            if (m.left && e >= 0)m.openAmount(m.left.width * t); else if (m.right && 0 > e) {
                {
                    m.right.width
                }
                m.openAmount(m.right.width * t)
            }
            o.enableClass(0 !== e, "menu-open"), c(!1)
        }, m.openAmount = function (e) {
            var t = m.left && m.left.width || 0, n = m.right && m.right.width || 0;
            return (m.left && m.left.isEnabled || !(e > 0)) && (m.right && m.right.isEnabled || !(0 > e)) ? l && e > t ? void m.content.setTranslateX(t) : s && -n > e ? void m.content.setTranslateX(-n) : (m.content.setTranslateX(e), void(e >= 0 ? (l = !0, s = !1, e > 0 && (m.right && m.right.pushDown && m.right.pushDown(), m.left && m.left.bringUp && m.left.bringUp())) : (s = !0, l = !1, m.right && m.right.bringUp && m.right.bringUp(), m.left && m.left.pushDown && m.left.pushDown()))) : void m.content.setTranslateX(0)
        }, m.snapToRest = function (e) {
            m.content.enableAnimation(), u = !1;
            var t = m.getOpenRatio();
            if (0 === t)return void m.openPercentage(0);
            var n = .3, i = e.gesture.velocityX, o = e.gesture.direction;
            m.openPercentage(t > 0 && .5 > t && "right" == o && n > i ? 0 : t > .5 && "left" == o && n > i ? 100 : 0 > t && t > -.5 && "left" == o && n > i ? 0 : .5 > t && "right" == o && n > i ? -100 : "right" == o && t >= 0 && (t >= .5 || i > n) ? 100 : "left" == o && 0 >= t && (-.5 >= t || i > n) ? -100 : 0)
        }, m.enableMenuWithBackViews = function (e) {
            return arguments.length && ($ = !!e), $
        }, m.isAsideExposed = function () {
            return !!v
        }, m.exposeAside = function (e) {
            (m.left && m.left.isEnabled || m.right && m.right.isEnabled) && (m.close(), v = e, m.left && m.left.isEnabled ? m.content.setMarginLeft(v ? m.left.width : 0) : m.right && m.right.isEnabled && m.content.setMarginRight(v ? m.right.width : 0), m.$scope.$emit("$ionicExposeAside", v))
        }, m.activeAsideResizing = function (e) {
            o.enableClass(e, "aside-resizing")
        }, m._endDrag = function (e) {
            c(!1), v || (u && m.snapToRest(e), d = null, f = null, p = null)
        }, m._handleDrag = function (t) {
            !v && e.dragContent && (d ? f = t.gesture.touches[0].pageX : (d = t.gesture.touches[0].pageX, f = d), !u && Math.abs(f - d) > m.dragThresholdX && (d = f, u = !0, m.content.disableAnimation(), p = m.getOpenAmount()), u && (m.openAmount(p + (f - d)), c(!0)))
        }, m.canDragContent = function (t) {
            return arguments.length && (e.dragContent = !!t), e.dragContent
        }, m.edgeThreshold = 25, m.edgeThresholdEnabled = !1, m.edgeDragThreshold = function (e) {
            return arguments.length && (h(e) && e > 0 ? (m.edgeThreshold = e, m.edgeThresholdEnabled = !0) : m.edgeThresholdEnabled = !!e), m.edgeThresholdEnabled
        }, m.isDraggableTarget = function (t) {
            var n = m.edgeThresholdEnabled && !m.isOpen(), i = t.gesture.startEvent && t.gesture.startEvent.center && t.gesture.startEvent.center.pageX, o = !n || i <= m.edgeThreshold || i >= m.content.element.offsetWidth - m.edgeThreshold, a = r.backView(), c = $ ? !0 : !a;
            if (!c) {
                var s = r.currentView() || {};
                return a.historyId !== s.historyId
            }
            return (e.dragContent || m.isOpen()) && o && !t.gesture.srcEvent.defaultPrevented && c && !t.target.tagName.match(/input|textarea|select|object|embed/i) && !t.target.isContentEditable && !(t.target.dataset ? t.target.dataset.preventScroll : "true" == t.target.getAttribute("data-prevent-scroll"))
        }, e.sideMenuContentTranslateX = 0;
        var w = g, b = angular.bind(m, m.close);
        e.$watch(function () {
            return 0 !== m.getOpenAmount()
        }, function (e) {
            w(), e && (w = i.registerBackButtonAction(b, S))
        });
        var y = n._registerInstance(m, t.delegateHandle, function () {
            return r.isActiveScope(e)
        });
        e.$on("$destroy", function () {
            y(), w(), m.$scope = null, m.content && (m.content.element = null, m.content = null), c(!1)
        }), m.initialize({left: {width: 275}, right: {width: 275}})
    }]), function (e) {
        function t(e, i, o, r) {
        ...
        var r = "translate(32,32)", a = "stroke-opacity", c = "round", s = "indefinite", u = "750ms", d = "none", f = {
            a: "animate",
            an: "attributeName",
            at: "animateTransform",
            c: "circle",
            ...
            t: "transform",
            v: "values"
        }, h = {v: "0,32,32;360,32,32", an: "transform", type: "rotate", rc: s, dur: u}, p = {
            sw: 4,
            lc: c,
            line: [{
                fn: function (e, t) {
                    return {
                        ...
                        a: [{
                            fn: function () {
                                return {an: a, dur: u, v: i("0;.1;.15;.25;.35;.45;.55;.65;.7;.85;1", e), rc: s}
                            }, t: 1
                        }]
                    }
                }, t: 12
                ...
                sw: 0, c: [{
                    fn: function (e) {
                        return {
                            ...
                            a: [{
                                fn: function () {
                                    return {an: "r", dur: u, v: i("1;2;3;4;5;6;7;8", e), rc: s}
                                }, t: 1
                            }]
                        }
                    }, t: 8
                ...
                c: [{
                    fn: function (e) {
                        return {
                            ...
                            a: [{
                                fn: function () {
                                    return {an: "fill-opacity", dur: u, v: i(".3;.3;.3;.4;.7;.85;.9;1", e), rc: s}
                                }, t: 1
                            }]
                        }
                    }, t: 8
                    ...
                    fn: function (e) {
                        return {
                            cx: 16 + 16 * e, cy: 32, sw: 0, a: [{
                                fn: function () {
                                    return {an: "fill-opacity", dur: u, v: i(".5;.6;.8;1;.8;.6;.5", e), rc: s}
                                }, t: 1
                            }, {
                                fn: function () {
                                    return {an: "r", dur: u, v: i("4;5;6;5;4;3;3", e), rc: s}
                                }, t: 1
                            }]
                        }
                    }, t: 3
                    ...
                    fn: function (e) {
                        return {
                            x1: 10 + 14 * e, x2: 10 + 14 * e, a: [{
                                fn: function () {
                                    return {an: "y1", dur: u, v: i("16;18;28;18;16", e), rc: s}
                                }, t: 1
                            }, {
                                fn: function () {
                                    return {an: "y2", dur: u, v: i("48;44;36;46;48", e), rc: s}
                                }, t: 1
                            }, {
                                fn: function () {
                                    return {an: a, dur: u, v: i("1;.8;.5;.4;1", e), rc: s}
                                }, t: 1
                            }]
                        }
                    }, t: 4
                    ...
                    fn: function (e) {
                        return {
                            cx: 32, cy: 32, a: [{
                                ...
                                fn: function () {
                                    return {an: a, begin: -1 * e + "s", dur: "2s", v: ".2;1;.2;0", rc: s}
                                }, t: 1
                            }]
                        }
                    }, t: 2
            ...
            android: function (t) {
                function i() {
                    var t = o(Date.now() - r, 650), u = 1, d = 0, f = 188 - 58 * t, h = 182 - 182 * t;
                    a % 2 && (u = -1, d = -64, f = 128 - -58 * t, h = 182 * t);
                    var p = [0, -101, -90, -11, -180, 79, -270, -191][a];
                    n(l, "da", Math.max(Math.min(f, 188), 128)), n(l, "os", Math.max(Math.min(h, 182), 0)), n(l, "t", "scale(" + u + ",1) translate(" + d + ",0) rotate(" + p + ",32,32)"), c += 4.1, c > 359 && (c = 0), n(s, "t", "rotate(" + c + ",32,32)"), t >= 1 && (a++, a > 7 && (a = 0), r = Date.now()), e.requestAnimationFrame(i)
                }

                var r, a = 0, c = 0, s = t.querySelector("g"), l = t.querySelector("circle");
                return function () {
                    r = Date.now(), i()
                }
            }
        };
        l.controller("$ionicSpinner", ["$element", "$attrs", function (n, i) {
            var o, r;
            this.init = function () {
                o = i.icon || e.Platform.platform(), r = v[o], r || (o = "ios", r = v.ios);
                var a = document.createElement("div");
                return t("svg", {viewBox: "0 0 64 64", g: [v[o]]}, a, o), n.html(a.innerHTML), this.start(), o
            }, this.start = function () {
                g[o] && g[o](n[0])()
            }
        }])
    }(ionic), l.controller("$ionicTab", ["$scope", "$ionicHistory", "$attrs", "$location", "$state", function (e, t, n, i, o) {
    ...
    }]), l.controller("$ionicTabs", ["$scope", "$element", "$ionicHistory", function (e, t, n) {
        var i, o = this, r = null, a = null;
        o.tabs = [], o.selectedIndex = function () {
            ...
            e.$tabSelected && (a = r, r = i = null, e.$tabSelected = !1, (e.onDeselect || g)(), e.$broadcast && e.$broadcast("$ionicHistory.deselect"))
            ...
            1 === arguments.length && (a = !(!t.navViewName && !t.uiSref)), r && r.$historyId == t.$historyId ? a && n.goToHistoryRoot(t.$historyId) : i !== c && (d(o.tabs, function (e) {
                o.deselect(e)
            }), r = t, i = c, o.$scope && o.$scope.$parent && (o.$scope.$parent.$activeHistoryId = t.$historyId), t.$tabSelected = !0, (t.onSelect || g)(), a && e.$emit("$ionicHistory.change", {
                type: "tab",
                tabIndex: c,
                historyId: t.$historyId,
    ...
    }]), l.controller("$ionicView", ["$scope", "$element", "$attrs", "$compile", "$rootScope", "$ionicViewSwitcher", function (e, t, n, i, o) {
        function r() {
            var t = f(n.viewTitle) && "viewTitle" || f(n.title) && "title";
            t && (a(n[t]), $.push(n.$observe(t, a))), f(n.hideBackButton) && $.push(e.$watch(n.hideBackButton, function (e) {
                d.showBackButton(!e)
            })), f(n.hideNavBar) && $.push(e.$watch(n.hideNavBar, function (e) {
                d.showBar(!e)
            }))
        }

        function a(e) {
            f(e) && e !== v && (v = e, d.title(v))
        }
        ...
        var d, h, p, v, g = this, m = {}, $ = [], w = e.$on("ionNavBar.init", function (e, t) {
            e.stopPropagation(), h = t
        });
        g.init = function () {
            w();
            var n = t.inheritedData("$ionModalController");
            d = t.inheritedData("$ionNavViewController"), d && !n && (e.$on("$ionicView.beforeEnter", g.beforeEnter), e.$on("$ionicView.afterEnter", r), e.$on("$ionicView.beforeLeave", c))
        }, g.beforeEnter = function (t, i) {
            if (i && !i.viewNotified) {
                i.viewNotified = !0, o.$$phase || e.$digest(), v = f(n.viewTitle) ? n.viewTitle : n.title;
                var r = {};
                for (var a in m)r[a] = s(m[a]);
                d.beforeEnter(u(i, {
                    title: v,
                    showBack: !l("hideBackButton"),
                    navBarItems: r,
                    navBarDelegate: h || null,
                    showNavBar: !l("hideNavBar"),
                    hasHeaderBar: !!p
                })), c()
            }
    ...
    }]), l.directive("ionActionSheet", ["$document", function (e) {
        return {
            restrict: "E",
            scope: !0,
            replace: !0,
    ...
    }]), l.directive("ionCheckbox", ["$ionicConfig", function (e) {
        return {
            restrict: "E",
            replace: !0,
            require: "?ngModel",
    ...
    }]), l.directive("collectionRepeat", e).factory("$ionicCollectionManager", t);
    var x = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", A = /height:.*?px;\s*width:.*?px/, E = 3;
    e.$inject = ["$ionicCollectionManager", "$parse", "$window", "$$rAF", "$rootScope", "$timeout"], t.$inject = ["$rootScope", "$window", "$$rAF"], l.directive("ionContent", ["$timeout", "$controller", "$ionicBind", "$ionicConfig", function (e, t, n, i) {
        return {
            restrict: "E", require: "^?ionNavView", scope: !0, priority: 800, compile: function (e, o) {
                function r(e, r, c) {
                    var s = e.$parent;
                    if (e.$watch(function () {
                            return (s.$hasHeader ? " has-header" : "") + (s.$hasSubheader ? " has-subheader" : "") + (s.$hasFooter ? " has-footer" : "") + (s.$hasSubfooter ? " has-subfooter" : "") + (s.$hasTabs ? " has-tabs" : "") + (s.$hasTabsTop ? " has-tabs-top" : "")
                        }, function (e, t) {
                            r.removeClass(t), r.addClass(e)
                        }), e.$hasHeader = e.$hasSubheader = e.$hasFooter = e.$hasSubfooter = e.$hasTabs = e.$hasTabsTop = !1, n(e, c, {
                            $onScroll: "&onScroll",
                            ...
                            startY: "@",
                            scrollEventInterval: "@"
                        }), e.direction = e.direction || "y", f(c.padding) && e.$watch(c.padding, function (e) {
                            (a || r).toggleClass("padding", !!e)
                        }), "false" === c.scroll); else if ("true" !== o.overflowScroll && i.scrolling.jsScrolling()) {
                        var l = {
                            el: r[0],
                            ...
                            scrollingComplete: function () {
                                e.$onScrollComplete({scrollTop: this.__scrollTop, scrollLeft: this.__scrollLeft})
                            }
                        };
                        t("$ionicScroll", {$scope: e, scrollViewOptions: l}), e.$on("$destroy", function () {
                            l.scrollingComplete = g, delete l.el, a = null, r = null, o.$$element = null
                        })
                    } else r.addClass("overflow-scroll")
                }

                var a;
                return e.addClass("scroll-content ionic-scroll"), "false" != o.scroll ? (a = v('<div class="scroll"></div>'), a.append(e.contents()), e.append(a)) : e.addClass("scroll-content-false"), {pre: r}
            }
        }
    }]), l.directive("exposeAsideWhen", ["$window", function (e) {
        return {
            restrict: "A", require: "^ionSideMenus", link: function (t, n, i, o) {
                ...
                function a() {
                    o.activeAsideResizing(!0), c()
                }

                var c = ionic.debounce(function () {
                    t.$apply(r)
                }, 300, !1);
                r(), ionic.on("resize", a, e), t.$on("$destroy", function () {
                    ionic.off("resize", a, e)
                })
            }
        }
    }]);
    var V = "onHold onTap onDoubleTap onTouch onRelease onDrag onDragUp onDragRight onDragDown onDragLeft onSwipe onSwipeUp onSwipeRight onSwipeDown onSwipeLeft".split(" ");
    V.forEach(function (e) {
        l.directive(e, n(e))
    }), l.directive("ionHeaderBar", o()).directive("ionHeaderBar", r(!0)).directive("ionFooterBar", r(!1)), l.directive("ionInfiniteScroll", ["$timeout", function (e) {
        return {
            restrict: "E", require: ["?^$ionicScroll", "ionInfiniteScroll"], template: function (e, t) {
                ...
                var r = o[1], a = r.scrollCtrl = o[0], c = r.jsScrolling = !!a;
                if (c)r.scrollView = a.scrollView; else {
                ...
                c ? (t.scrollingType = "js-scrolling", a.$element.on("scroll", r.checkBounds)) : r.scrollEl.addEventListener("scroll", r.checkBounds);
                var l = f(i.immediateCheck) ? t.$eval(i.immediateCheck) : !0;
                l && e(function () {
                    r.checkBounds()
                })
            }
    ...
    var P = '<a class="item-content" ng-href="{{$href()}}" target="{{$target()}}"></a>', D = '<div class="item-content"></div>';
    l.directive("ionItem", ["$$rAF", function (e) {
        return {
            restrict: "E", controller: ["$scope", "$element", function (e, t) {
                this.$scope = e, this.$element = t
            }], scope: !0, compile: function (t, n) {
                var i = f(n.href) || f(n.ngHref) || f(n.uiSref), o = i || /ion-(delete|option|reorder)-button/i.test(t.html());
                if (o) {
                    var r = v(i ? P : D);
                    r.append(t.contents()), t.append(r), t.addClass("item item-complex")
                } else t.addClass("item");
                return function (t, n, i) {
                    t.$href = function () {
                        return i.href || i.ngHref
                    }, t.$target = function () {
                        return i.target || "_self"
                    };
    ...
    var L = '<div class="item-left-edit item-delete enable-pointer-events"></div>';
    l.directive("ionDeleteButton", function () {
        return {
            restrict: "E",
            require: ["^^ionItem", "^?ionList"],
            priority: Number.MAX_VALUE,
            compile: function (e, t) {
                return t.$set("class", (t["class"] || "") + " button icon button-icon", !0), function (e, t, n, i) {
                    function o() {
                        a = a || t.controller("ionList"), a && a.showDelete() && c.addClass("visible active")
                    }

                    var r = i[0], a = i[1], c = v(L);
                    c.append(t), r.$element.append(c).addClass("item-left-editable"), o(), e.$on("$ionic.reconnectScope", o)
                }
            }
        }
    }), l.directive("itemFloatingLabel", function () {
        return {
    ...
    var _ = '<div class="item-options invisible"></div>';
    l.directive("ionOptionButton", ["$compile", function () {
        function e(e) {
            e.stopPropagation()
        }
        ...
        return {
            restrict: "E", require: "^ionItem", priority: Number.MAX_VALUE, compile: function (t, n) {
                return n.$set("class", (n["class"] || "") + " button", !0), function (t, n, i, o) {
                    o.optionsContainer || (o.optionsContainer = v(_), o.$element.append(o.optionsContainer)), o.optionsContainer.append(n), o.$element.addClass("item-right-editable"), n.on("click", e)
                }
            }
        }
    }]);
    var R = '<div data-prevent-scroll="true" class="item-right-edit item-reorder enable-pointer-events"></div>';
    l.directive("ionReorderButton", ["$parse", function (e) {
        return {
            restrict: "E",
            require: ["^ionItem", "^?ionList"],
            priority: Number.MAX_VALUE,
    ...
    }]), l.directive("keyboardAttach", function () {
        return function (e, t) {
            function n(e) {
                if (!ionic.Platform.isAndroid() || ionic.Platform.isFullScreen) {
                    var n = e.keyboardHeight || e.detail.keyboardHeight;
                    t.css("bottom", n + "px"), o = t.controller("$ionicScroll"), o && (o.scrollView.__container.style.bottom = n + a(t[0]) + "px")
                }
            }

            function i() {
                (!ionic.Platform.isAndroid() || ionic.Platform.isFullScreen) && (t.css("bottom", ""), o && (o.scrollView.__container.style.bottom = ""))
            }
    ...
    }), l.directive("ionList", ["$timeout", function (e) {
        return {
            restrict: "E",
            require: ["ionList", "^?$ionicScroll"],
            controller: "$ionicList",
            compile: function (t, n) {
                var i = v('<div class="list">').append(t.contents()).addClass(n.type);
                return t.append(i), function (t, i, o, r) {
                    function a() {
                        ...
                        t.$on("$destroy", function () {
                        ...
                        }), f(n.canSwipe) && t.$watch("!!(" + n.canSwipe + ")", function (e) {
                            c.canSwipeItems(e)
                        }), f(n.showDelete) && t.$watch("!!(" + n.showDelete + ")", function (e) {
                            c.showDelete(e)
                        }), f(n.showReorder) && t.$watch("!!(" + n.showReorder + ")", function (e) {
                            c.showReorder(e)
                        }), t.$watch(function () {
                            return c.showDelete()
                        }, function (e, t) {
                            if (e || t) {
                                ...
                                var n = v(i[0].getElementsByClassName("item-delete"));
                                o(n, c.showDelete)
                            }
                        }), t.$watch(function () {
                            ...
                            if (e || t) {
                                ...
                                var n = v(i[0].getElementsByClassName("item-reorder"));
                                o(n, c.showReorder)
                            }
                        })
                    }
    ...
    }]), l.directive("menuClose", ["$ionicHistory", function (e) {
        return {
            restrict: "AC", link: function (t, n) {
                n.bind("click", function () {
                    var t = n.inheritedData("$ionSideMenusController");
                    t && (e.nextViewOptions({historyRoot: !0, disableAnimate: !0, expire: 300}), t.close())
                })
            }
        }
    }]), l.directive("menuToggle", function () {
        return {
    ...
    }]), l.directive("ionModalView", function () {
        return {
            restrict: "E", compile: function (e) {
                e.addClass("modal")
            }
        }
    }), l.directive("ionNavBackButton", ["$ionicConfig", "$document", function (e, t) {
        return {
            restrict: "E", require: "^ionNavBar", compile: function (n, i) {
                ...
                i.ngClick || r.setAttribute("ng-click", "$ionicGoBack($event)"), r.className = "button back-button hide buttons " + (n.attr("class") || ""), r.innerHTML = n.html() || "";
    ...
    }]), l.directive("ionNavBar", function () {
        return {
            restrict: "E", controller: "$ionicNavBar", scope: !0, link: function (e, t, n, i) {
                i.init()
            }
        }
    }), l.directive("ionNavButtons", ["$document", function (e) {
        return {
    ...
    }]), l.directive("navDirection", ["$ionicViewSwitcher", function (e) {
        return {
    ...
    }]), l.directive("ionNavTitle", ["$document", function (e) {
        return {
            require: "^ionNavBar", restrict: "E", compile: function (t, n) {
    ...
    }]), l.directive("navTransition", ["$ionicViewSwitcher", function (e) {
        return {
            restrict: "A", priority: 1e3, link: function (t, n, i) {
                n.bind("click", function () {
    ...
    }]), l.directive("ionNavView", ["$state", "$ionicConfig", function (e, t) {
        return {
            restrict: "E",
            terminal: !0,
            priority: 2e3,
        ...
        return {
            restrict: "A", link: function (e, t, n) {
                t.bind(n.ionStopEvent, c)
            }
        }
    }), l.directive("ionPane", function () {
        return {
            restrict: "E", link: function (e, t) {
                t.addClass("pane")
            }
        }
    }), l.directive("ionPopover", [function () {
        return {
    ...
    }]), l.directive("ionPopoverView", function () {
        return {
            restrict: "E", compile: function (e) {
                e.append(v('<div class="popover-arrow">')), e.addClass("popover")
            }
        }
    }), l.directive("ionRadio", function () {
        return {
            restrict: "E",
            replace: !0,
            require: "?ngModel",
    ...
    }), l.directive("ionRefresher", [function () {
        return {
            restrict: "E",
            replace: !0,
            ...
            link: function (e, t, n, i) {
                var o = i[0], r = i[1];
                o ? (t[0].classList.add("js-scrolling"), o._setRefresher(e, t[0], r.getRefresherDomMethods()), e.$on("scroll.refreshComplete", function () {
    ...
    }]), l.directive("ionScroll", ["$timeout", "$controller", "$ionicBind", function (e, t, n) {
        return {
            restrict: "E", scope: !0, controller: function () {
                ...
                function i(e, i, r) {
                    ...
                    n(e, r, {
                        ...
                        minZoom: "@",
                        maxZoom: "@"
                    }), e.direction = e.direction || "y", f(r.padding) && e.$watch(r.padding, function (e) {
                        o.toggleClass("padding", !!e)
                    }), e.$eval(e.paging) === !0 && o.addClass("scroll-paging"), e.direction || (e.direction = "y");
                    var s = e.$eval(e.paging) === !0, l = {
                        el: i[0],
                    ...
                    s && (l.speedMultiplier = .8, l.bouncing = !1), c = t("$ionicScroll", {
                        $scope: e,
                        scrollViewOptions: l
                    }), a = e.$parent.scrollView = c.scrollView
                }

                e.addClass("scroll-view ionic-scroll");
                var o = v('<div class="scroll"></div>');
                return o.append(e.contents()), e.append(o), {pre: i}
            }
        }
    }]), l.directive("ionSideMenu", function () {
        return {
    ...
    }), l.directive("ionSideMenuContent", ["$timeout", "$ionicGesture", "$window", function (e, t, n) {
        return {
            restrict: "EA", require: "^ionSideMenus", scope: !0, compile: function (i, o) {
                function r(r, a, c, s) {
                    ...
                    function p(e) {
                        ...
                        if (e && e.gesture) {
                            if (v) {
                                var t = ionic.tap.pointerCoord(e.gesture.srcEvent), n = Math.abs(t.x - v.x), i = Math.abs(t.y - v.y), o = i > n ? "y" : "x";
                    ...
                    var v = null, g = null;
                    f(o.dragContent) ? r.$watch(o.dragContent, function (e) {
                        s.canDragContent(e)
                    }) : s.canDragContent(!0), f(o.edgeDragThreshold) && r.$watch(o.edgeDragThreshold, function (e) {
                    ...
                    s.setContent(m);
                    var $ = {stop_browser_behavior: !1}, w = t.on("tap", l, a, $), b = t.on("dragright", u, a, $), y = t.on("dragleft", u, a, $), S = t.on("dragup", d, a, $), k = t.on("dragdown", d, a, $), C = t.on("release", h, a, $);
                    r.$on("$destroy", function () {
                        m && (m.element = null, m = null), t.off(y, "dragleft", u), t.off(b, "dragright", u), t.off(S, "dragup", d), t.off(k, "dragdown", d), t.off(C, "release", h), t.off(w, "tap", l)
                    })
                }
    ...
    }]), l.directive("ionSideMenus", ["$ionicBody", function (e) {
        return {
    ...
    }]), l.directive("ionSlideBox", ["$timeout", "$compile", "$ionicSlideBoxDelegate", "$ionicHistory", function (e, t, n, i) {
        return {
            restrict: "E",
            replace: !0,
            transclude: !0,
            ...
            controller: ["$scope", "$element", "$attrs", function (t, o, r) {
                var a = t.$eval(t.doesContinue) === !0, c = f(r.autoPlay) ? !!t.autoPlay : !1, s = c ? t.$eval(t.slideInterval) || 4e3 : 0, l = new ionic.views.Slider({
                    el: o[0],
                    auto: s,
                    continuous: a,
                    startSlide: t.activeSlide,
                    slidesChanged: function () {
                        t.currentSlide = l.currentIndex(), e(function () {
                        })
                    },
                    callback: function (n) {
                ...
                l.enableSlide(t.$eval(r.disableScroll) !== !0), t.$watch("activeSlide", function (e) {
                    f(e) && l.slide(e)
                ...
                var u = n._registerInstance(l, r.delegateHandle, function () {
                    return i.isActiveScope(t)
                });
                t.$on("$destroy", u), this.slidesCount = function () {
                    return l.slidesCount()
            ...
            link: function (e, n, i) {
                function o() {
                    if (!r) {
                        var i = e.$new();
                        r = v("<ion-pager></ion-pager>"), n.append(r), r = t(r)(i)
                    }
                    return r
                }

                i.$observe("showPager", function (t) {
                    t = e.$eval(t), o().toggleClass("hide", !t)
                });
                var r
            }
        }
        ...
        return {
            restrict: "E", require: "^ionSlideBox", compile: function (e) {
                return e.addClass("slider-slide"), function () {
                }
            }
        }
    ...
    }), l.directive("ionSpinner", function () {
        return {
    ...
    }), l.directive("ionTab", ["$compile", "$ionicConfig", "$ionicBind", "$ionicViewSwitcher", function (e, t, n, i) {
        function o(e, t) {
            return f(t) ? " " + e + '="' + t + '"' : ""
        }
        ...
        return {
            ...
            compile: function (r, a) {
                ...
                r.empty();
                var d, f;
                return u && ("ION-NAV-VIEW" === s.children[0].tagName && (d = s.children[0].getAttribute("name"), s.children[0].classList.add("view-container"), f = !0), 1 === u && (s = s.children[0]), f || s.classList.add("pane"), s.classList.add("tab-content")), function (o, r, a, l) {
                    function f() {
                        w.tabMatchesState() && $.select(o, !1)
                    }

                    function h(n) {
                        n && u ? (b || (g = o.$new(), m = v(s), i.viewEleIsActive(m, !0), $.$element.append(m), e(m)(g), b = !0), i.viewEleIsActive(m, !0)) : b && m && (t.views.maxCache() > 0 ? i.viewEleIsActive(m, !1) : p())
                    }
                    ...
                    }), r[0].removeAttribute("title"), d && (w.navViewName = o.navViewName = d), o.$on("$stateChangeSuccess", f), f();
                    var y = v(c);
                    y.data("$ionTabsController", $), y.data("$ionTabController", w), $.$tabsElement.append(e(y)(o)), o.$watch("$tabSelected", h), o.$on("$ionicView.afterEnter", function () {
    ...
    }]), l.directive("ionTabNav", [function () {
        return {
            restrict: "E",
            replace: !0,
            require: ["^ionTabs", "^ionTab"],
    ...
    }]), l.directive("ionTabs", ["$ionicTabsDelegate", "$ionicConfig", "$ionicHistory", function (e, t) {
        return {
            restrict: "E", scope: !0, controller: "$ionicTabs", compile: function (n) {
                function i(t, n, i, o) {
                    ...
                    o.$scope = t, o.$element = n, o.$tabsElement = v(n[0].querySelector(".tabs")), t.$watch(function () {
                        return n[0].className
                    }, function (e) {
                ...
                var r = v('<div class="tab-nav tabs">');
    ...
    }]), l.directive("ionToggle", ["$timeout", "$ionicConfig", function (e, t) {
        return {
            restrict: "E",
            replace: !0,
            require: "?ngModel",
            ...
            compile: function (e, n) {
                ...
                return d({
                    ...
                    var n = t[0].getElementsByTagName("label")[0], i = n.children[0], o = n.children[1], r = o.children[0], a = v(i).controller("ngModel");
